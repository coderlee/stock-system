...
Route::group(['prefix' => 'agent', 'middleware' => ['agent_auth']], function () {
    ...
    Route::get('loginUserAdmin', 'Agent\MemberController@loginUserAdmin');//当前登录用户
    Route::post('delAgent', 'Agent\MemberController@delAgent');//删除代理
    Route::post('opencloseRisk', 'Agent\MemberController@opencloseRisk');//开启关闭点控
