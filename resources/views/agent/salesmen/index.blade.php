        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                ...
                <script type="text/html" id="table-useradmin-webuser">
                    ...
                    <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="this-del"><i class="layui-icon layui-icon-group"></i>删除</a>
                    @{{#  if(d.risk == 1){ }}
                    <a class="layui-btn layui-btn-normal diankong layui-btn-xs" lay-event="this-risk"><i class="layui-icon layui-icon-group"></i>关闭点控</a>
                     @{{#  } else { }}
                     <a class="layui-btn layui-btn-normal diankong layui-btn-xs" lay-event="this-risk"><i class="layui-icon layui-icon-group"></i>开启点控</a>
                      @{{#  } }}
                </script>
            </div>
        </div>
