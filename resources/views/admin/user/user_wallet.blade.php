                        ...
                        function tbRend(url) {
                            table.render({
                                ...
                                , cols: [[
                                    ...
                                    ,{field:'lever_balance',title:'合约交易余额', width:150}
                                    ,{field:'lock_lever_balance',title:'合约交易锁定余额', width:150}

                                    ,{field:'legal_balance',title:'法币交易余额', width:150}
                                    ,{field:'lock_legal_balance',title:'法币交易锁定余额', width:150}

                                    ,{field:'change_balance',title:'币币交易余额', width:150}
                                    ,{field:'lock_change_balance',title:'币币交易锁定余额', width:150}

                                    ,{field:'status',title:'锁定状态', width:100, templet: '#switchTpl'}
