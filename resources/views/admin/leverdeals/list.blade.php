...
@section('page-content')
    <div style="margin-top: 10px;width: 100%;margin-left: 10px;">
        ...
        <form class="layui-form layui-form-pane layui-inline" action="">
            ...
            <div class="layui-inline" style="margin-left: 50px;">
                <label>订单状态&nbsp;&nbsp;</label>
                <div class="layui-input-inline">
                    <select name="status" id="status" placeholder="请输入">
            ...
            <div class="layui-inline" style="margin-left: 50px;">
                <label>交易类型&nbsp;&nbsp;</label>
                <div class="layui-input-inline">
                    <select name="type" id="type" placeholder="请输入">
    ...
    {{--<div class="layui-inline layui-row">--}}
        ...
        {{--<div class="layui-input-inline">--}}
            {{--<input type="text" name="id" placeholder="请输入" autocomplete="off" class="layui-input" value="">--}}
        {{--</div>--}}

        {{--<label class="layui-form-label">用户名</label>--}}
        {{--<div class="layui-input-inline">--}}
            {{--<input type="text" name="phone" placeholder="请输入" autocomplete="off" class="layui-input" value="">--}}
        {{--</div>--}}
    ...
    <button class="layui-btn layui-btn-normal" onclick="javascrtpt:window.location.href='{{url('/admin/Leverdeals/csv')}}'">导出用户</button>

    {{--<button class="layui-btn layui-btn-normal" id="ajax_jie">结算</button>--}}
                ...
                function tbRend(url) {
                    table.render({
                        ...
                        , cols: [[
                            ...
                            ,{field: 'phone', title: '用户名', minWidth: 150 , event : "getsons",style:"color: #fff;background-color: #5FB878;"}
