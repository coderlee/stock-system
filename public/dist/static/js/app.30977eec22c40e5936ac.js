webpackJsonp([12], {
		...
		var s = {
				...
				created: function() {
					localStorage.getItem("skin") && "nights" == localStorage.getItem("skin") ? this.value3 = !1 : this.value3 = !0,
						"/" !== this.$route.path ? this.homeindex = !1 : this.homeindex = !0, this.skins, this.srcImg1 =
						"../../static/imgs/logob.png", this.address = localStorage.getItem("token") || "";
				...
				mounted: function() {
					...
					this.$http({
						...
						}).catch(function(t) {}), t.account_number = localStorage.getItem("accountNum") || "", t.extension_code =
						localStorage.getItem("extension_code") || "";
					var a = window.localStorage.getItem("is_seller") || "",
						s = window.localStorage.getItem("status") || "";
					1 == a && 1 == s && (t.isShow = !0), eventBus.$on("seller", function(e) {
						if (e) {
							var a = window.localStorage.getItem("is_seller") || "",
								s = window.localStorage.getItem("status") || "";
							1 == a && 1 == s && (t.isShow = !0)
				...
				methods: {
					...
					tabLange: function(t) {
						this.langImg = t.imgs, this.langText = t.label, this.modelShow = !1;
						var e = t.value;
						localStorage.setItem("lang", e), this.$i18n.locale = e, this.$http({
							url: "/api/set/lang",
							method: "post",
							data: {
								lang: e
					...
					selectedTab: function(t) {
						location.reload(), 1 == t ? localStorage.setItem("skin", "days") : localStorage.setItem("skin", "nights")
					},
					handleCommand: function(t) {
						var e = this;
						if ("signOut" == t) {
							var a = localStorage.getItem("lang");
							localStorage.clear(), localStorage.setItem("lang", a), setTimeout(function() {
								e.$router.push({
			...
			i = {
				render: function() {
					...
					return a("div", {
						...
						}, [t._v(t._s(t.$t("miscro.assetCenter")))])], 1), t._v(" "), a("el-dropdown-item", [a(
							"router-link", {
								attrs: {
									to: "/financialRecords"
								}
							}, [t._v(t._s(t.$t("asset.moneyRecord")))])], 1)], 1)], 1)], 1) : t._e(), t._v(" "), t.userAccount ?
						a("li", [a("el-dropdown", {
							attrs: {
								trigger: "click"
							},
						...
						}, [t._v(t._s(t.$t("jc.out")))])], 1)], 1)], 1) : t._e(), t._v(" "), t.userAccount ? t._e() : a("li",
							[a("router-link", {
								attrs: {
									to: "/components/login"
								}
							}, [t._v(t._s(t.$t("header.login")))])], 1), t._v(" "), t.userAccount ? t._e() : a("li", [a(
							"router-link", {
								attrs: {
	...
	NHnr: function(t, e, a) {
		...
		var U = a("VU/8")({
			...
			z = (a("mgS3"), {
				...
				created: function() {
					var t = this;
					this.account_number = "", this.password = "", this.init(), this.$http({
						url: "/api/news/list",
						method: "post",
						data: {
							c_id: 4
				...
				beforeCreate: function() {
					localStorage.getItem("skin") && "nights" == localStorage.getItem("skin") ? document.querySelector("html").setAttribute(
						"style", "background-color:#000;") : document.querySelector("html").setAttribute("style",
				...
				methods: {
						...
						this.$http({
							...
							if ("ok" == e.data.type) {
								for (var a = [], s = 0; s < e.data.message.length; s++)
									for (var i = 0; i < e.data.message[s].quotation.length; i++) a.push(e.data.message[s].quotation[i]);
								t.quotationList = a, t.marketSocket()
							}
						}).catch(function(t) {})
					},
					userInfo: function() {
						...
						this.$http({
							...
							if ("ok" == e.data.type) {
								if (localStorage.setItem("user_id", e.data.message.id), localStorage.setItem("userAccount", e.data.message
										.account), localStorage.setItem("extension_code", e.data.message.extension_code), localStorage.setItem(
										"is_seller", e.data.message.is_seller), e.data.message.seller && e.data.message.seller.length > 0) {
					...
					login: function() {
						...
						if ("" != this.account_number.length)
							if (this.password.length < 6) layer.tips(this.$t("login.psw6"), "#pwd");
							else {
								var s = layer.load();
								this.$http({
									url: "/api/user/login",
									...
									layer.close(s), "ok" === (a = a.data).type ? (localStorage.setItem("token", a.message), localStorage.setItem(
										"accountNum", e), t.$store.commit("setAccountNum"), t.userInfo()) : layer.msg(a.message)
								}).catch(function(t) {})
							}
						else layer.tips(this.$t("set.enterAccount"), "#account")
					},
					inputs: function() {
					...
					marketSocket: function() {
						var t = this;
						t.$socket.emit("login", localStorage.getItem("user_id")), t.$socket.on("daymarket", function(e) {
							if ("daymarket" == e.type)
								for (var a = 0; a < t.quotationList.length; a++) t.quotationList[a].legal_id == e.legal_id && t.quotationList[
									a].currency_id == e.currency_id && (t.quotationList[a].now_price = e.now_price, t.quotationList[a].change =
									e.change, t.quotationList[a].volume = e.volume)
						})
					},
					links: function() {
						this.$router.push({
			...
			Y = {
				render: function() {
					...
					return s("div", {
						...
						staticClass: "text"
					}, [s("p", [t._v(t._s(t.$t("lg.login9")))]), t._v(" "), s("p", [t._v(t._s(t.$t("lg.login10")))]),
						t._v(" "), s("p", [t._v(t._s(t.$t("lg.login11")))])
					])]), t._v(" "), s("li", [s("h4", [t._v(t._s(t.$t("lg.login12")))]), t._v(" "), t._m(1), t._v(" "), s(
						"div", {
							staticClass: "text"
						}, [s("p", [t._v(t._s(t.$t("lg.login13")))]), t._v(" "), s("p", [t._v(t._s(t.$t("lg.login14")))]),
							t._v(" "), s("p", [t._v(t._s(t.$t("lg.login15")))])
						])]), t._v(" "), s("li", [s("h4", [t._v(t._s(t.$t("lg.login16")))]), t._v(" "), t._m(2), t._v(" "),
						s("div", {
							staticClass: "text"
						}, [s("p", [t._v(t._s(t.$t("lg.login17")))]), t._v(" "), s("p", [t._v(t._s(t.$t("lg.login18")))]),
							t._v(" "), s("p", [t._v(t._s(t.$t("lg.login19")))])
						])
					])])]), t._v(" "), s("div", {
						staticClass: "about-us"
					}, [s("div", {
							staticClass: "about-us-info"
						}, [s("h3", [t._v(t._s(t.$t("foo.about")))]), t._v(" "), s("p", [t._v(t._s(t.$t("lg.login20")))]), t._v(
							" "), s("p", [t._v(t._s(t.$t("lg.login21")))]), t._v(" "), s("p", [t._v(t._s(t.$t("lg.login22")))])]),
						t._v(" "), t._m(3)
					]), t._v(" "), s("div", {
						staticClass: "pt"
					}, [s("div", {
		...
		var H = a("VU/8")(W, V, !1, function(t) {
			...
			q = {
				...
				created: function() {
					this.token = window.localStorage.getItem("token") || "", "" == this.token && this.$router.push(
						"/components/login"), this.getInfo()
				},
				methods: {
					getInfo: function() {
						var t = this;
						this.$http({
							...
							if ("ok" == e.data.type && null != e.data.message.account_number) {
								...
								t.name = a.real_name, t.bankName = a.bank_name, t.bankNum = a.bank_account, t.ali = a.alipay_account, t.weChatAccount =
									a.wechat_account, t.weChatName = a.wechat_nickname, t.src1 = a.alipay_qr_code, t.src2 = a.wechat_qr_code
							}
						})
					},
					add: function() {
						var t = "",
							e = "";
						t = "../../static/imgs/addimg.png" == this.src1 ? "" : this.src1, e = "../../static/imgs/addimg.png" == this.src2 ?
							"" : this.src2, this.$http({
					...
					uploads: function(t) {
						...
						$.ajax({
							...
							contentType: !1,
							success: function(a) {
								layer.close(s), "ok" == a.type ? 1 == t ? e.src1 = a.message : e.src2 = a.message : (layer.msg(a.message),
									1 == t ? e.src1 = "../../static/imgs/addimg.png" : e.src2 = "../../static/imgs/addimg.png")
							}
						})
					}
				}
			...
			st = {
				...
				computed: {
					listenState: function() {
						return this.createWidget(), this.symbol
					}
				},
				watch: {
				...
				methods: {
					connect: function(t) {
						var e = this;
						e.$socket.emit("login", localStorage.getItem("user_id")), e.$socket.on("kline", function(a) {
							var s = {},
								i = localStorage.getItem("type");
							e.symbol == a.symbol && i == a.period && (s.open = Number(a.open), s.low = Number(a.low), s.high = Number(
								a.high), s.close = Number(a.close), s.volume = Number(a.volume), s.time = Number(a.time), localStorage.setItem(
								"newPrice", a.close), t(s))
						})
					},
					createWidget: function() {
						var t = this,
							e = "#ffffff";
						e = "nights" == localStorage.getItem("skin") ? "#1e2b34" : "#ffffff", this.$nextTick(function() {
							var a = t.widget = new TradingView.widget({
								...
								disabled_features: ["header_saveload", "compare_symbol", "display_market_status", "go_to_date",
									"header_chart_type", "header_compare", "header_interval_dialog_button", "header_resolutions",
									"header_screenshot", "header_symbol_search", "header_undo_redo", "legend_context_menu",
									"show_hide_button_in_legend", "show_interval_dialog_on_key_press", "snapshot_trading_drawings",
									"symbol_info", "timeframes_toolbar", "use_localstorage_for_settings", "volume_force_overlay",
									"widget_logo"
								],
								enabled_features: ["dont_show_boolean_study_arguments", "hide_last_na_study_output",
									"move_logo_to_main_pane", "same_data_requery", "side_toolbar_in_fullscreen_mode",
							...
							a.MAStudies = [], a.selectedIntervalButton = null, a.onChartReady(function() {
								...
								[{
									...
									n.attr("title", s.text).addClass("my2").text(s.text), s.text == t.$t("kline.text2") && (n.css({
										"background-color": "#f0b90b",
										color: "#fff"
									}), localStorage.setItem("tim", "1min"), localStorage.setItem("type", "1min")), n.on("click",
										function(t) {
											$(this).parents(".left").children().find(".my2").removeAttr("style"), e(t, s.value), a.chart().setChartType(
												s.chartType)
										})
								});
								var e = function(e, s, i) {
									...
									}, localStorage.setItem("tim", s), localStorage.setItem("type", i), a.chart().setResolution(s,
										function() {}), $(e.target).addClass("mydate").closest("div.space-single").siblings(
										"div.space-single").find("div.button").removeClass("mydate")
								}
							}), t.widget = a
						})
					},
					createFeed: function() {
						var t = this,
							e = {
								DataPulseUpdater: function(t, e) {
									this._datafeed = t, this._subscribers = {}, this._requestsPending = 0;
									var a = this;
															...
															if (a._requestsPending--, a._subscribers.hasOwnProperty(t) && 0 !== s.length) {
																...
																if (isNaN(e.lastBarTime) || !(i.time < e.lastBarTime)) {
																	...
																	if (!isNaN(e.lastBarTime) && i.time > e.lastBarTime) {
																		...
																		for (var r = s[s.length - 2], o = 0; o < n.length; ++o) n[o](r)
																	}
																	for (e.lastBarTime = i.time, o = 0; o < n.length; ++o) n[o](i)
																}
															}
														}, function() {
															a._requestsPending--
						...
						return e.DataPulseUpdater.prototype.periodLengthSeconds = function(t, e) {
							...
							this._datafeed._logMessage("Subscribing " + s), this._subscribers.hasOwnProperty(s) || (this._subscribers[s] = {
								symbolInfo: t,
								resolution: e,
								lastBarTime: NaN,
								listeners: []
							...
							this._datafeed._logMessage("Unsubscribing " + t), delete this._subscribers[t]
							...
							this._configuration = {
									...
									exchanges: ["gh"]
								}, this._barsPulseUpdater = new e.DataPulseUpdater(this, t || 1e4), this._enableLogging = !0, this._callbacks = {},
								this._initializationFinished = !0, this._fireEvent("initialized"), this._fireEvent("configuration_ready")
						}, e.Container.prototype._fireEvent = function(t, e) {
							if (this._callbacks.hasOwnProperty(t)) {
								for (var a = this._callbacks[t], s = 0; s < a.length; ++s) a[s](e);
								this._callbacks[t] = []
							}
						}, e.Container.prototype._logMessage = function(t) {
							if (this._enableLogging) new Date
						}, e.Container.prototype.on = function(t, e) {
							return this._callbacks.hasOwnProperty(t) || (this._callbacks[t] = []), this._callbacks[t].push(e), this
							...
							this._logMessage("GOWNO :: resolve symbol " + e), n.a.resolve().then(function() {
								a({
									name: t.symbol,
									timezone: "Asia/Shanghai",
							...
							-1 == e.indexOf("D") && -1 == e.indexOf("W") && -1 == e.indexOf("M") ? e += "min" : -1 == e.indexOf("W") &&
								-1 == e.indexOf("M") || (e = e), $.ajax({
									...
									success: function(t) {
										1 == t.code && t.data && t.data.length > 0 && (t.data.forEach(function(t, e) {
											t.open = Number(t.open), t.close = Number(t.close), t.high = Number(t.high), t.low = Number(t.low),
		...
		var nt = a("VU/8")(st, it, !1, function(t) {
			...
			rt = {
				...
				methods: {
					tabs: function(t, e, a) {
						this.index1 = t, "seconds" == this.secondsType ? this.$router.push({
							name: "secondsOrder",
							query: {
								legalId: e,
								currencyId: a
			...
			ot = {
				render: function() {
					...
					return a("div", {
						...
						}, [a("li", [a("p", [t._v(t._s(t._f("numFilters")(e.now_price || "0.00", 4)))]), t._v(" "), a("p", [t
								._v(t._s(t.$t("market.newprice")))
							])]), t._v(" "), a("li", [a("p", {
								class: e.change < 0 ? "redColor" : "greenColor"
							}, [t._v(t._s(e.change || "0.00") + "%")]), t._v(" "), a("p", [t._v(t._s(t.$t("market.change")))])]),
							t._v(" "), a("li", [a("p", [t._v("≈" + t._s(t._f("numFilters")(e.now_price * e.rmb_relation ||
								"0.00", 2)) + "CNY")]), t._v(" "), a("p", [t._v(t._s(t.$t("asset.conversion")))])]), t._v(" "), a(
								"li", [a("p", [t._v(t._s(t._f("numFilters")(e.volume || "0.00", 0)))]), t._v(" "), a("p", [t._v(t._s(
									t.$t("market.vol")))])])
						]) : t._e()
					})], 2)])
				},
			...
			ut = {
				render: function() {
					...
					return a("div", {
						...
						staticClass: "tc"
					}, [t._v(t._s(t.$t("miscro.category")))]), t._v(" "), a("span", [t._v(t._s(t.$t("cuy.price")))]), t._v(
						" "), a("span", {
						staticClass: "tc"
						...
						}, [t._v(t._s(t.$t("cuy.sell")) + " " + t._s(t.datas.sellList.length - s))]), t._v(" "), a("span",
							[t._v(t._s(t._f("numFilters")(e[0], 4)))]), t._v(" "), a("span", {
							staticClass: "tc"
						...
						}, [t._v(t._s(t.$t("cuy.buy")) + "  " + t._s(s + 1))]), t._v(" "), a("span", [t._v(t._s(t._f(
							"numFilters")(e[0], 4)))]), t._v(" "), a("span", {
							staticClass: "tc"
						}, [t._v(t._s(t._f("numFilters")(100 * e[1], 2)))])])
					})], 2)])])
				},
			...
			pt = ht()({
				...
				methods: {
					selectTypes: function(t) {
						this.selectedStatus = t, this.multNum = "", this.shareNum = "", this.marketTotal = 0, this.bonds = 0, this.serviceCharge =
							0
					},
					selectBuy: function() {
						this.buyType = 1 == this.buyType ? "2" : "1", this.multNum = "", this.shareNum = "", this.marketTotal = 0,
							this.bonds = 0, this.serviceCharge = 0
					},
					buyBtn: function() {
						return "" == this.multNum ? (layer.msg(this.$t("lever.ptimes")), !1) : "" == this.shareNum ? (layer.msg(this
							.$t("lever.hand3")), !1) : 0 == this.selectedStatus && "" == this.controlInput ? (layer.msg(this.$t(
							"lever.pprice")), !1) : void(this.dialogVisible = !0)
					},
					calculation: function() {
						var t = "";
						this.spread = localStorage.getItem("spread"), 1 == this.selectedStatus && 1 == this.buyType ? t = (Number(
								this.obj.newPrice - 0) + Number(this.spread - 0)) * (this.shareNum - 0) * (this.obj.currencyList.lever_share_num -
								0) : 1 == this.selectedStatus && 2 == this.buyType ? t = (Number(this.obj.newPrice - 0) - Number(this.spread -
								0)) * (this.shareNum - 0) * (this.obj.currencyList.lever_share_num - 0) : 0 == this.selectedStatus && 1 ==
							this.buyType ? t = (Number(this.controlInput - 0) + Number(this.spread - 0)) * (this.shareNum - 0) * (this.obj
								.currencyList.lever_share_num - 0) : 0 == this.selectedStatus && 2 == this.buyType && (t = (Number(this.controlInput -
								0) - Number(this.spread - 0)) * (this.shareNum - 0) * (this.obj.currencyList.lever_share_num - 0)), this.multNum >
							0 && (this.bonds = t / (this.multNum - 0)), this.marketTotal = t, this.serviceCharge = t * (this.obj.currencyList
								.lever_trade_fee - 0) / 100
					},
					transferSumbit: function() {
						...
						this.$http({
							...
							layer.msg(e.data.message), "ok" == e.data.type && setTimeout(function() {
								t.$router.push({
									name: "leverList"
								})
							}, 1e3)
				...
				render: function() {
					...
					return a("div", {
						staticClass: "trade"
							...
							}, [t._v("1" + t._s(t.$t("lever.hand")) + t._s(t.$t("lever.equal")) + " " + t._s(t._f("numFilters")(t.obj
								.currencyList.lever_share_num || "0.00", 2)) + " " + t._s(t.obj.currencyList.currency_name))]), t._v(" "),
							a("div", {
							...
							}, [a("span", [t._v(t._s(t.$t("lever.contractVal")))]), t._v(" "), a("span", [t._v("≈" + t._s(t._f(
								"numFilters")(t.marketTotal || "0.00", 4)))])]), t._v(" "), a("p", {
								staticClass: "flex between mt10"
							}, [a("span", [t._v(t._s(t.$t("lever.bail")))]), t._v(" "), a("span", [t._v("≈" + t._s(t._f(
								"numFilters")(t.bonds || "0.00", 4)))])]), t._v(" "), a("p", {
								staticClass: "flex between mt10"
							}, [a("span", [t._v(t._s(t.$t("ctc.balance")))]), t._v(" "), a("span", [t._v(t._s(t.obj.balance ||
								"0.00"))])])])
						]), t._v(" "), a("div", {
						...
						}, [t._v(t._s(1 == t.buyType ? t.$t("td.buyin") : t.$t("td.sellout")) + t._s(t.obj.currencyList.currency_name))]),
						t._v(" "), a("el-dialog", {
							attrs: {
								title: "",
						...
						}, [a("p", [t._v(t._s(t.obj.currencyList.currency_name) + "/" + t._s(t.obj.currencyList.legal_name))]),
							t._v(" "), a("div", {
								staticClass: "flex"
							}, [a("p", [t._v(t._s(t.$t("fat.type")) + "：")]), t._v(" "), a("p", [t._v(t._s(1 == t.buyType ? t.$t(
								"td.buyin") : t.$t("td.sellout")))])]), t._v(" "), a("div", {
								staticClass: "flex"
							}, [a("p", [t._v(t._s(t.$t("lever.hands")) + "：")]), t._v(" "), a("p", [t._v(t._s(t.shareNum))])]), t
							._v(" "), a("div", {
								staticClass: "flex"
							}, [a("p", [t._v(t._s(t.$t("lever.timed")) + "：")]), t._v(" "), a("p", [t._v(t._s(t.multNum))])]), t._v(
								" "), a("div", {
								staticClass: "flex"
							}, [a("p", [t._v(t._s(t.$t("lever.bail")) + "：")]), t._v(" "), a("p", [t._v(t._s(t._f("numFilters")(
								t.bonds || "0.00", 4)))])]), t._v(" "), a("div", {
								staticClass: "flex"
							}, [a("p", [t._v(t._s(t.$t("lever.rate")) + "：")]), t._v(" "), a("p", [t._v(t._s(t._f("numFilters")(
								t.serviceCharge || "0.00", 4)))])])
						])]), t._v(" "), a("span", {
		...
		var vt = a("VU/8")(pt, gt, !1, function(t) {
			...
			ft = {
				...
				watch: {
					...
					$route: function(t, e) {
						this.leverData.currencyId = t.query.currencyId, this.page = 1, 1 == this.page && (this.list_content = [])
					}
				},
				created: function() {},
				methods: {
					init: function() {
						var t = this,
							e = this;
						this.more = e.$t("lever.loading"), this.$http({
							...
							"ok" == a.data.type ? (t.more = t.$t("td.more"), t.list_content = t.list_content.concat(a.data.message.order
									.data), 1 == e.page && t.loads(), t.riskRate = a.data.message.hazard_rate, t.totalPro = a.data.message.profits_total,
								t.profitsPrice = a.data.message.profits, t.total = a.data.message.order.total, 0 == a.data.message.order
								.data.length && e.page > 1 && (t.more = t.$t("td.nomore")), 0 == a.data.message.order.data.length && 1 ==
								e.page && (t.more = t.$t("td.nodata"))) : layer.msg(a.data.message)
						}).catch(function(t) {})
					},
					loads: function() {
						var t = this;
						t.$socket.emit("login", localStorage.getItem("user_id")), t.$socket.on("lever_trade", function(e) {
							if ("lever_trade" == e.type) {
								...
								if (t.riskRate = e.hazard_rate, t.totalPro = e.profits_all, t.profitsPrice = e.profits, a.length > 0) {
									var s = [];
									for (var i in a) t.leverData.legalId == a[i].legal && t.leverData.currencyId == a[i].currency && s.push(
										a[i]);
									t.list_content = s
								}
							}
					...
					stopLoss: function(t) {
						for (var e in this.modalShow = !0, this.list_content) this.list_content[e].id == t && (this.shareNum = this.list_content[
								e].share, this.modalId = this.list_content[e].id, this.presentPrice = this.$utils.filterDecimals(this.list_content[
								e].price, 2), this.openPrice = this.$utils.filterDecimals(this.list_content[e].update_price, 2), this.list_content[
								e].target_profit_price > 0 ? this.targetProfit = this.$utils.filterDecimals(this.list_content[e].target_profit_price,
								2) : this.targetProfit = this.openPrice, this.list_content[e].stop_loss_price > 0 ? this.stopLose = this.$utils
							.filterDecimals(this.list_content[e].stop_loss_price, 2) : this.stopLose = this.openPrice, 1 == this.list_content[
								e].type ? (this.orderType = "buy", this.list_content[e].target_profit_price > 0 ? this.modalProfit = this.$utils
								.filterDecimals((this.targetProfit - parseFloat(this.list_content[e].price) - 0) * (this.list_content[e].share -
									0), 2) : this.modalProfit = "0.00", this.list_content[e].stop_loss_price > 0 ? this.modalStop = this.$utils
								.filterDecimals((this.$utils.filterDecimals(this.list_content[e].price, 2) - this.stopLose - 0) * (this.list_content[
									e].share - 0), 2) : this.modalStop = "0.00") : (this.orderType = "sell", this.list_content[e].target_profit_price >
								0 ? this.modalProfit = this.$utils.filterDecimals((this.$utils.filterDecimals(this.list_content[e].price,
									2) - this.targetProfit - 0) * (this.list_content[e].share - 0), 2) : this.modalProfit = "0.00", this.list_content[
									e].stop_loss_price > 0 ? this.modalStop = this.$utils.filterDecimals((this.stopLose - parseFloat(this.list_content[
									e].price) - 0) * (this.list_content[e].share - 0), 2) : this.modalStop = "0.00"))
					},
					add: function(t) {
						"buy" == this.orderType ? 1 == t ? (this.targetProfit = this.$utils.filterDecimals(parseFloat(this.targetProfit) +
							.01, 2), this.modalProfit = this.$utils.filterDecimals((parseFloat(this.targetProfit) - this.presentPrice -
							0) * (this.shareNum - 0), 2)) : (this.stopLose = this.$utils.filterDecimals(parseFloat(this.stopLose) + .01,
							2), this.modalStop = this.$utils.filterDecimals((this.presentPrice - this.stopLose - 0) * (this.shareNum -
							0), 2)) : 1 == t ? (this.targetProfit = this.$utils.filterDecimals(parseFloat(this.targetProfit) + .01, 2),
							this.modalProfit = this.$utils.filterDecimals((parseFloat(this.presentPrice - this.targetProfit) - 0) * (
								this.shareNum - 0), 2)) : (this.stopLose = this.$utils.filterDecimals(parseFloat(this.stopLose) + .01, 2),
							this.modalStop = this.$utils.filterDecimals((parseFloat(this.stopLose - this.presentPrice) - 0) * (this.shareNum -
								0), 2))
					},
					reduce: function(t) {
						"buy" == this.orderType ? 1 == t ? this.targetProfit > 0 ? (this.targetProfit = this.$utils.filterDecimals(
								parseFloat(this.targetProfit) - .01, 2), this.modalProfit = this.$utils.filterDecimals((parseFloat(this.targetProfit) -
								this.presentPrice - 0) * (this.shareNum - 0), 2)) : layer.msg(this.$t("lever.thanzone")) : this.stopLose >
							0 ? (this.stopLose = this.$utils.filterDecimals(parseFloat(this.stopLose) - .01, 2), this.modalStop = this.$utils
								.filterDecimals((this.presentPrice - this.stopLose - 0) * (this.shareNum - 0), 2)) : layer.msg(this.$t(
								"lever.thanzone")) : 1 == t ? this.targetProfit > 0 ? (this.targetProfit = this.$utils.filterDecimals(
								parseFloat(this.targetProfit) - .01, 2), this.modalProfit = this.$utils.filterDecimals((this.presentPrice -
								this.targetProfit - 0) * (this.shareNum - 0), 2)) : layer.msg(this.$t("lever.thanzone")) : this.stopLose >
							0 ? (this.stopLose = this.$utils.filterDecimals(parseFloat(this.stopLose) - .01, 2), this.modalStop = this.$utils
								.filterDecimals((parseFloat(this.stopLose - this.presentPrice) - 0) * (this.shareNum - 0), 2)) : layer.msg(
								this.$t("lever.thanzone"))
					},
					inputValue: function(t) {
						if ("buy" == this.orderType)
							if (1 == t) {
								var e = this.$utils.filterDecimals((parseFloat(this.targetProfit) - parseFloat(this.presentPrice) - 0) * (
									this.shareNum - 0), 2);
								this.modalProfit = e > 0 ? e : 0
							} else {
								var a = this.$utils.filterDecimals((parseFloat(this.presentPrice) - parseFloat(this.stopLose) - 0) * (this.shareNum -
									0), 2);
								this.modalStop = a > 0 ? a : 0
							}
						else if (1 == t) {
							var s = this.$utils.filterDecimals((parseFloat(this.presentPrice) - parseFloat(this.targetProfit) - 0) * (
								this.shareNum - 0), 2);
							this.modalProfit = s > 0 ? s : 0
						} else {
							var i = this.$utils.filterDecimals((parseFloat(this.stopLose) - parseFloat(this.presentPrice) - 0) * (this.shareNum -
								0), 2);
					...
					comfirm: function() {
						...
						this.$http({
							...
							if ("ok" == e.data.type)
								for (var a in t.modalShow = !1, layer.msg(e.data.message), t.list_content) t.modalId == t.list_content[a]
									.id && (t.list_content[a].target_profit_price = t.targetProfit, t.list_content[a].stop_loss_price = t.stopLose);
							else layer.msg(e.data.message)
						}).catch(function(t) {})
					},
					stopTotal: function() {
						this.stopModal = !0
					...
					comfirmModal: function() {
						var t = this,
							e = 0;
						e = "all" == t.selectType ? 0 : "buy" == t.selectType ? 1 : 2, this.$http({
							...
							"ok" == e.data.type ? (t.stopModal = !1, layer.msg(e.data.message), t.list_content = [], t.init()) : (t.stopModal = !
								1, layer.msg(e.data.message))
						}).catch(function(e) {
							t.stopModal = !1
						})
					},
				...
				render: function() {
					...
					return s("div", {
						...
						return s("li", {
							...
							staticClass: "width3 tls"
						}, [t._v(t._s(1 == e.type ? t.$t("td.buyin") : t.$t("td.sellout")) + " " + t._s(e.symbol) + " x" + t
							._s(e.share) + "(No." + t._s(e.id) + ")")]), t._v(" "), s("span", {
							staticClass: "width1"
		...
		var _t = a("VU/8")(ft, yt, !1, function(t) {
			...
			bt = {
				...
				watch: {
					$route: function(t, e) {
						this.leverData.currencyId != t.query.currencyId && location.reload(), this.leverData.currencyId = t.query.currencyId,
							this.init(), this.positionSocket()
					}
				},
				beforeCreate: function() {
					localStorage.getItem("skin") && "nights" == localStorage.getItem("skin") ? (document.querySelector("html").setAttribute(
						"style", "background:#000;"), document.querySelector("body").setAttribute("style", "background:#000;")) : (
						document.querySelector("html").setAttribute("style", "background:#f8f6f6;"), document.querySelector("body").setAttribute(
							"style", "background:#f8f6f6;"))
				},
				created: function() {
					var t = this;
					t.token = localStorage.getItem("token"), t.leverData.legalId = this.$route.query.legalId || "", t.leverData.currencyId =
						this.$route.query.currencyId || "";
					var e = new Date,
						a = e.getFullYear(),
						s = e.getMonth(),
						i = e.getDate(),
						...
						r = e.getMinutes(),
						o = e.getSeconds();
					t.years = a + "-" + s + "-" + i, t.times = n + ":" + r + ":" + o, setInterval(function() {
						e = new Date, a = e.getFullYear(), s = e.getMonth() - 0 + 1, i = e.getDate(), n = e.getHours(), r = e.getMinutes(),
							o = e.getSeconds(), s < 10 && (s = "0" + s), i < 10 && (i = "0" + i), n < 10 && (n = "0" + n), r < 10 && (
								r = "0" + r), o < 10 && (o = "0" + o), t.years = a + "-" + s + "-" + i, t.times = n + ":" + r + ":" + o
					}, 1e3)
				},
				mounted: function() {
					this.init(), this.positionSocket(), this.getWallet()
				},
				beforeDestroy: function() {
					document.querySelector("html").removeAttribute("style"), document.querySelector("body").removeAttribute(
						"style")
				},
				methods: {
					getWallet: function() {
					...
					init: function() {
						...
						this.$http({
							...
							if ("ok" == e.data.type) {
								for (var a = [], s = 0; s < e.data.message.length; s++)
									for (var i = 0; i < e.data.message[s].quotation.length; i++) 1 == e.data.message[s].quotation[i].is_display &&
										(a.push(e.data.message[s].quotation[i]), t.leverData.legalId == e.data.message[s].quotation[i].legal_id &&
											t.leverData.currencyId == e.data.message[s].quotation[i].currency_id && (t.leverTrade.currencyList = e
												.data.message[s].quotation[i], t.symbol = e.data.message[s].quotation[i].currency_name + "/" + e.data
												.message[s].quotation[i].legal_name));
								t.quotationList = a, "" == t.symbol && (t.symbol = a[0].currency_name + "/" + a[0].legal_name, t.leverData
										.legalId = a[0].legal_id, t.leverData.currencyId = a[0].currency_id, t.leverTrade.currencyList = a[0]),
									t.getDeal(), localStorage.setItem("spread", t.leverTrade.currencyList.spread), t.marketSocket()
							}
						}).catch(function(t) {})
					},
					getDeal: function() {
						...
						this.$http({
							...
							if ("ok" == e.data.type) {
								t.leverTrade.muilList = e.data.message.multiple, t.leverTrade.leverLimit = e.data.message.lever_share_limit,
									t.leverTrade.balance = e.data.message.user_lever, t.leverTrade.newPrice = e.data.message.last_price;
								var a = [],
									s = [],
									i = [],
									n = [];
								if (e.data.message.lever_transaction.in.length > 0) {
									...
									for (var o in r)(a = [])[0] = r[o].price, a[1] = r[o].number, s.push(a)
								}
								if (e.data.message.lever_transaction.out.length > 0) {
									var c = e.data.message.lever_transaction.out.reverse();
									for (var o in c)(i = [])[0] = c[o].price, i[1] = c[o].number, n.push(i)
								}
								t.topBuy.buyList = s, t.topBuy.sellList = n, t.topBuy.newsPrice = e.data.message.last_price, t.buySocket()
							}
						})
					},
					marketSocket: function() {
					...
					buySocket: function() {
						var t = this;
						t.$socket.emit("login", localStorage.getItem("user_id")), t.$socket.on("market_depth", function(e) {
							if ("market_depth" == e.type) {
								var a = e.bids,
									s = e.asks;
								e.currency_id == t.leverData.currencyId && e.legal_id == t.leverData.legalId && (t.topBuy.buyList = a, t.topBuy
									.sellList = s)
							}
						})
					},
					positionSocket: function() {
						var t = this;
						t.$socket.emit("login", localStorage.getItem("user_id")), t.$socket.on("kline", function(e) {
			...
			St = ht()({
				...
				methods: {
					...
					getDeal: function() {
						...
						this.$http({
							...
							if ("ok" == e.data.type && (t.datas = e.data.message, e.data.message.length > 0)) {
								for (var a = 0; a < e.data.message.length; a++) "AITB" == e.data.message[a].name && (t.bmbBalance = e.data
									.message[a].user_wallet.insurance_balance, t.insurancType = e.data.message[a].insurance_types, e.data.message[
										a].user_insurance && (t.userInsurancId = e.data.message[a].user_insurance.insurance_type_id));
								t.currency_id = e.data.message[0].id, t.numList = e.data.message[0].micro_numbers, e.data.message[0].user_wallet &&
									(t.balance = e.data.message[0].user_wallet.micro_with_insurance), t.serviceCharge = e.data.message[0].micro_trade_fee,
									t.inputValue = t.$utils.filterDecimals(t.numList[0].number, 0), t.tradeName = e.data.message[0].name
							}
						}), this.$http({
							...
							"ok" == e.data.type && (t.timeList = e.data.message, t.profitRatio = e.data.message[0].profit_ratio, t.value4 =
								e.data.message[0].seconds)
						})
					},
					selectBuy: function() {
						this.buyType = 1 == this.buyType ? "2" : "1", this.multNum = "", this.shareNum = "", this.marketTotal = 0,
					...
					currencyTab: function(t) {
						this.currency_id = t.id, this.numList = t.micro_numbers, t.user_wallet && (this.balance = t.user_wallet.micro_with_insurance),
							this.tradeName = t.name, this.serviceCharge = t.micro_trade_fee, this.inputValue = this.$utils.filterDecimals(
								this.numList[0].number, 0)
					},
					selectNum: function(t) {
						this.inputValue = this.$utils.filterDecimals(t, 0)
					},
					selectTime: function(t, e) {
						this.value4 = t, this.profitRatio = e
					},
					transferSumbit: function(t) {
						if (this.buyType = t, !this.inputValue) return layer.msg(this.$t("miscro.openNum")), !1;
						this.modalShow = !0
					},
					comfirm: function() {
						var t = this;
						this.$http({
							...
							t.modalShow = !1, "ok" == e.data.type ? (layer.msg(t.$t("miscro.success")), t.$http({
								url: "/api/microtrade/payable_currencies",
								method: "get",
								data: {},
								headers: {
								...
								if ("ok" == e.data.type && e.data.message.length > 0)
									for (var a = 0; a < e.data.message.length; a++) e.data.message[a].id == t.currency_id && (t.balance =
										e.data.message[a].user_wallet.micro_with_insurance)
			...
			Bt = {
				render: function() {
					...
					return s("div", {
						...
						staticClass: "flex between mt10"
					}, [s("span", [t._v(t._s(t.$t("ctc.balance")))]), t._v(" "), s("span", [t._v(t._s(t.balance || "0.00") +
						t._s(t.tradeName))])]), t._v(" "), s("p", {
						staticClass: "flex between mt10"
					}, [s("span", [t._v(t._s(t.$t("miscro.rate")))]), t._v(" "), s("span", [t._v(t._s(t.profitRatio ||
						"0.00") + "%")])])])]), t._v(" "), s("div", [s("div", {
						...
						staticClass: "transfer-content"
					}, [s("h3", [t._v(t._s(1 == t.buyType ? t.$t("miscro.up") : t.$t("miscro.down")) + " " + t._s(t.currencyName))]),
						t._v(" "), s("div", {
							staticClass: "transfer-list mt10"
						}, [s("div", {
							staticClass: "loss-madal-content flex between"
						}, [s("div", [s("span", [t._v(t._s(t.$t("td.num")))]), t._v(" "), s("span", [t._v(t._s(t._f(
							"numFilters")(t.inputValue || "0", 0)) + " " + t._s(t.tradeName))])]), t._v(" "), s("div", [s(
							"span", [t._v(t._s(t.$t("td.time")))]), t._v(" "), s("span", [t._v(t._s(t._f("numFilters")(t.value4 ||
							"0", 0)) + "S")])]), t._v(" "), s("div", [s("span", [t._v(t._s(t.$t("miscro.rate")))]), t._v(" "),
							s("span", [t._v(t._s(t._f("numFilters")(t.profitRatio || "0", 0)) + "%")])
						])])])
					]), t._v(" "), s("span", {
						staticClass: "dialog-footer",
						attrs: {
		...
		var xt = a("VU/8")(St, Bt, !1, function(t) {
				a("V2+S")
			...
			Et = {
				...
				computed: {
					switchStatus: function() {
						if ("" != this.tradeId && 0 != this.tradeId) return this.tradeId
					}
				},
				created: function() {},
				mounted: function() {
					...
					}, 1500), t.connect(), setInterval(function() {
						t.prices = localStorage.getItem("newPrice"), 1 == localStorage.getItem("orderStatus") && (t.page = 1, t.init())
					}, 1)
				},
				methods: {
					init: function() {
						var t = this;
						clearTimeout(t.set), clearInterval(t.sets);
						var e = {};
						1 == t.status ? (t.tradeId, e = {
							...
							if ("ok" == e.data.type)
								if (e.data.message.data.length > 0) {
									for (var a = e.data.message.data, s = (new Date).getTime(), i = 0; i < a.length; i++) a[i].endTime = s -
										0 + (a[i].remain_milli_seconds - 0);
									t.orderList = a, t.Djs_time(), t.set = setTimeout(t.countDown, 200), t.more = t.$t("td.more")
								} else t.more = t.$t("td.nodata");
							else layer.msg(e.data.message)
						}).catch(function(t) {})
					},
					load_more: function() {
					...
					tabOrder: function(t) {
						this.status = t, this.orderList = [], this.page = 1, this.init()
					},
					connect: function() {
						var t = this;
						t.$socket.emit("login", localStorage.getItem("user_id")), t.$socket.on("closed_microorder", function(e) {
							if ("closed_microorder" == e.type)
								for (var a = e.data, s = 0; s < t.orderList.length; s++)
									if (t.orderList[s].id == a.id) return t.orderList[s] = a, setTimeout(function() {
										var e = t.orderList;
										e.splice(s, 1), t.orderList = e
									}, 500), !1
						})
					}
				}
			...
			Pt = {
				render: function() {
					...
					return s("div", {
						...
						return t.orderList.length > 0 && e.remain_milli_seconds > 0 && 1 == t.status || 3 == t.status && t.orderList
							.length > 0 ? s("li", {
								key: i,
								staticClass: "flex between"
							}, [s("span", {
									...
									staticClass: "width1"
								}, [t._v(t._s(t._f("numFilters")(e.number || "0", 0)) + " " + t._s(e.currency_name))]), t._v(" "), s(
									"span", {
										staticClass: "width2"
									...
									staticClass: "width2"
								}, [t._v(t._s(t._f("numFilters")(t.prices || "0.00", 4)))]) : t._e(), t._v(" "), 1 == t.status && 3 ==
								e.status ? s("span", {
									staticClass: "width2"
								}, [t._v(t._s(t._f("numFilters")(e.end_price || "0.00", 4)))]) : t._e(), t._v(" "), 3 == t.status ? s(
									"span", {
										staticClass: "width2"
									}, [t._v(t._s(t._f("numFilters")(e.end_price || "0.00", 4)))]) : t._e(), t._v(" "), 1 == e.status &&
								1 == t.status && e.open_price - 0 == t.prices - 0 ? s("span", {
									staticClass: "width2 greenColor"
								}, [t._v("0")]) : t._e(), t._v(" "), 1 == e.status && 1 == t.status && 1 == e.type && e.open_price -
								0 > t.prices - 0 ? s("span", {
									staticClass: "width2 redColor"
								}, [t._v("-" + t._s(t._f("numFilters")(e.number || "0", 0)))]) : t._e(), t._v(" "), 1 == e.status &&
								1 == t.status && 1 == e.type && e.open_price - 0 <= t.prices - 0 ? s("span", {
									staticClass: "width2 greenColor"
								}, [t._v(t._s(t._f("numFilters")((e.number * e.profit_ratio - 0) / 100 || "0.00", 0)))]) : t._e(), t._v(
									" "), 1 == e.status && 1 == t.status && 2 == e.type && e.open_price - 0 >= t.prices - 0 ? s("span", {
									staticClass: "width2 greenColor"
								}, [t._v(t._s(t._f("numFilters")((e.number * e.profit_ratio - 0) / 100 || "0.00", 0)))]) : t._e(), t._v(
									" "), 1 == e.status && 1 == t.status && 2 == e.type && e.open_price - 0 < t.prices - 0 ? s("span", {
									staticClass: "width2 redColor"
								}, [t._v("-" + t._s(t._f("numFilters")(e.number - 0 || "0.00", 0)))]) : t._e(), t._v(" "), 1 == t.status &&
								3 == e.status ? s("span", {
									staticClass: "width2 trs",
									class: e.fact_profits < 0 ? "redColor" : "greenColor"
								}, [t._v(t._s(t._f("numFilters")(e.fact_profits || "0", 0)))]) : t._e(), t._v(" "), 1 == t.status &&
								1 == e.status ? s("span", {
									staticClass: "times width2 trs"
								}, [t._v(t._s(t.countDown(e.endTime, i, e.seconds)) + "s")]) : t._e(), t._v(" "), 1 == t.status && 3 ==
								e.status ? s("span", {
									staticClass: "times width2 trs"
								}, [t._v("0.0s")]) : t._e(), t._v(" "), 3 == t.status ? s("span", {
									staticClass: "width2"
								}, [t._v(t._s(t._f("numFilters")(e.fee || "0.00", 2)))]) : t._e(), t._v(" "), 3 == t.status ? s(
									"span", {
										staticClass: "width2 trs",
										class: e.fact_profits < 0 ? "redColor" : "greenColor"
									}, [t._v(t._s(t._f("numFilters")(e.fact_profits || "0", 2)))]) : t._e()
							]) : t._e()
		...
		var Lt = a("VU/8")(Et, Pt, !1, function(t) {
			...
			Tt = {
				...
				created: function() {
					$("#app").css("background", "#000;"), document.querySelector("html").setAttribute("style", "background:#000;");
					this.token = localStorage.getItem("token"), this.leverData.legalId = this.$route.query.legalId || "", this.leverData
						.currencyId = this.$route.query.currencyId || ""
				},
				mounted: function() {
					var t = this;
					t.init(), t.getDeal(), setInterval(function() {
						1 == localStorage.getItem("orderStatus") && t.getDeal()
					}, 1)
				},
				beforeDestroy: function() {
					document.querySelector("html").removeAttribute("style"), document.getElementById("app").removeAttribute(
						"style")
				},
				methods: {
					init: function() {
						...
						this.$http({
							...
							if ("ok" == e.data.type) {
								for (var a = [], s = 0; s < e.data.message.length; s++)
									for (var i = 0; i < e.data.message[s].quotation.length; i++) 1 == e.data.message[s].quotation[i].is_display &&
										(a.push(e.data.message[s].quotation[i]), t.leverData.legalId == e.data.message[s].quotation[i].legal_id &&
											t.leverData.currencyId == e.data.message[s].quotation[i].currency_id && (t.symbol = e.data.message[s].quotation[
												i].currency_name + "/" + e.data.message[s].quotation[i].legal_name, t.leverTradeId = e.data.message[
												s].quotation[i].id, t.currencyName = e.data.message[s].quotation[i].currency_name));
								t.quotationList = a, "" == t.symbol && (t.symbol = a[0].currency_name + "/" + a[0].legal_name, t.leverData
									.legalId = a[0].legal_id, t.leverData.currencyId = a[0].currency_id, t.leverTradeId = a[0].id, t.currencyName =
									a[0].currency_name), t.marketSocket()
							}
						}).catch(function(t) {})
					},
					marketSocket: function() {
					...
					getDeal: function() {
						...
						this.$http({
							...
							if ("ok" == e.data.type) {
								var a = e.data.message;
								if (a.length > 0)
									for (var s = 0; s < a.length; s++) "AITB" == a[s].name && (t.bmbBalance = a[s].user_wallet.insurance_balance,
										t.insurancType = a[s].insurance_types, a[s].user_insurance && (t.userInsurancId = a[s].user_insurance.insurance_type_id)
									)
							}
						})
					}
		...
		var Dt = a("VU/8")(Tt, Nt, !1, function(t) {
			...
			Qt = {
				...
				created: function() {
					var t = this;
					this.account_number = "", this.password = "", this.init(), this.getSwiper(), this.$http({
						url: "/api/news/list",
						method: "post",
						data: {
							c_id: 4
						...
						if ("ok" == e.data.type) {
							var a = e.data.message;
							t.areaList = a, t.areaText = a[0].name, t.areaCode = a[0].area_code, t.areaId = a[0].id
						}
					})
				},
				beforeCreate: function() {
				...
				methods: {
					...
					login: function() {
						...
						if ("" != this.account_number.length)
							if (this.password.length < 6) layer.tips(this.$t("login.psw6"), "#pwd");
								...
								var s = {};
								s.user_string = e, s.password = a, s.type = 1, "mobile" == this.isMb && (s.area_code = this.areaCode, s.area_code_id =
									this.areaId);
								var i = layer.load();
								this.$http({
									url: "/api/user/login",
									...
									layer.close(i), "ok" === (a = a.data).type ? (localStorage.setItem("token", a.message), localStorage.setItem(
										"accountNum", e), t.$store.commit("setAccountNum"), t.userInfo()) : layer.msg(a.message)
								}).catch(function(t) {})
							}
						else layer.tips(this.$t("set.enterAccount"), "#account")
					...
					setIsMb: function(t) {
						this.account = "", this.pwd = "", this.repwd = "", this.code = "", this.invite = "", this.isMb = t, this.codeTrue = !
							1, this.showList = !1, this.provinces = [], this.cities = [], this.districts = [], this.province = {
								id: "",
								name: "请选择省"
							}, this.city = {
								id: "",
						...
						e.disabled = !1, e.innerHTML = this.$t("set.getCode")
					},
					getCity: function(t, e) {
						this.areaCode = e, this.areaId = t, this.showCity = !1
					}
				}
			},
			Mt = {
		...
		var Rt = a("VU/8")(Qt, Mt, !1, function(t) {
				a("NfiE")
			...
			Ut = {
				...
				created: function() {
					...
					e && (this.invite = e), this.init(), this.getSwiper(), this.$http({
						url: "/api/news/list",
						method: "post",
						data: {
							c_id: 4
				...
				methods: {
					...
					get_all_params: function() {
						for (var t, e = location.href, a = e.substring(e.indexOf("?") + 1, e.length).split("&"), s = {}, i = 0; t = a[
								i]; i++) {
							var n = t.substring(0, t.indexOf("=")).toLowerCase(),
								r = t.substring(t.indexOf("=") + 1, t.length);
							r.indexOf("#") > -1 && (r = r.split("#")[0]), s[n] = decodeURI(r)
						}
						return s
					},
					getRegion: function(t, e, a) {
						if ("" == e) return this.showList = !1, void(this.district = {
							id: t,
							name: a
						});
						if ("cities" == e) {
							if (a == this.province.name) return void(this.showList = "cities")
						} else if ("districts" == e && a == this.city.name) return void(this.showList = "districts")
					},
					setIsMb: function(t) {
						this.account = "", this.pwd = "", this.repwd = "", this.code = "", this.invite = "", this.isMb = t, this.codeTrue = !
							1, this.showList = !1, this.provinces = [], this.cities = [], this.districts = [], this.province = {
					...
					sendCode: function(t) {
						var e = this,
							a = (e.isMb, "sms_send"),
							s = {};
						if ("" == e.account) return layer.msg(e.$t("set.enterAccount")), !1;
						"email" == e.isMb ? (a = "sms_mail", s = {
							...
							if (layer.msg(a.data.message), "ok" == a.data.type) {
								...
								e.timer = setInterval(function() {
									if (t.target.innerHTML = s + e.$t("fat.second"), t.target.disabled = !0, 0 == s) return clearInterval(
										e.timer), t.target.innerHTML = e.$t("set.getCode"), void(t.target.disabled = !1);
									s--
								}, 1e3)
							}
						})
						...
						if ("" != this.account)
							if ("" != this.code) {
								...
								"mobile" == this.isMb ? (e = {
									...
									layer.msg(e.data.message), "ok" == e.data.type && (t.registerStatus = !1)
								})
							} else layer.msg(this.$t("set.enterCode"));
						else layer.msg(this.$t("set.enterAccount"))
					},
					register: function() {
						var t = this;
						if ("" != t.pwd)
							if (t.pwd.length < 6 || t.pwd.length > 16) layer.msg(t.$t("register.psw16"));
							else if ("" != t.repwd)
							if (t.pwd === t.repwd)
								if ("" != t.invite) {
									var e = {};
									t.isMb;
									e.type = t.isMb, e.user_string = t.account, e.code = t.code, e.password = t.pwd, e.re_password = t.repwd,
										e.extension_code = t.invite;
									var a = !0;
									"mobile" == t.isMb && (e.area_code = t.areaCode, e.area_code_id = t.areaId), a ? (a = !1, this.$http({
								...
								} else layer.msg(t.$t("register.inviteCode"));
						else layer.msg(t.$t("set.pswFalse"));
						else layer.msg(t.$t("set.enterPswagain"));
						else layer.msg(t.$t("set.enterPsw"))
					},
					marketSocket: function() {
						var t = this;
						t.$socket.emit("login", localStorage.getItem("user_id")), t.$socket.on("daymarket", function(e) {
			...
			Ft = {
				render: function() {
					...
					return a("div", {
					...
					}, [t._v(t._s(t.$t("register.emailRegister")))])])]), t._v(" "), "mobile" == t.isMb ? a(
						"div", {
							staticClass: "mt10"
						}, [a("div", {
						...
						}, [t._v(t._s(t.$t("set.getCode")))])])])])]) : t._e(), t._v(" "), "email" == t.isMb ? a(
						"div", {
							staticClass: "mt10"
						}, [a("div", {
							staticClass: "el-form-item__content"
						...
						}, [t._v(t._s(t.$t("lg.login")) + "BINGLEY")])
					])], 1)])])]), t._v(" "), a("div", {
						directives: [{
							name: "show",
							rawName: "v-show",
		...
		var jt = a("VU/8")(Jt, Zt, !1, function(t) {
				a("k/o1")
			...
			Yt = {
				render: function() {
					...
					return a("div", {
						...
						staticClass: "flex"
					}, [a("h3", [t._v(t._s(t.$t("set.verification")))]), t._v(" "), a("p", [t._v(t._s(t.$t(
						"miscro.safeText1")))])]), t._v(" "), a("p", [a("span", [t._v(t._s(t.phone))])])]), t._v(" "), a("li", {
						staticClass: "flex between"
					}, [a("div", {
						staticClass: "flex"
		...
		var Ot = a("VU/8")(zt, Yt, !1, function(t) {
				a("dS5w")
			...
			Wt = {
				...
				methods: {
					file1: function() {
						var t = this,
							e = new FileReader;
						e.readAsDataURL(event.target.files[0]), e.onload = function(t) {};
						var a = new FormData;
						a.append("file", event.target.files[0]), $.ajax({
							url: "/api/upload",
							type: "post",
							data: a,
							processData: !1,
					...
					updata: function() {
						...
						"" != this.name.length ? "" != this.card_id.length ? "../../static/imgs/addimg.png" != t.src1 &&
							"../../static/imgs/addimg.png" != t.src2 ? this.$http({
							...
							}).catch(function(t) {}) : layer.tips(t.$t("auth.pimg"), "#name") : layer.tips(t.$t("auth.pidcard"), "#card") :
							layer.tips(t.$t("auth.pname"), "#name")
					},
					Info: function() {
						var t = this;
						this.$http({
			...
			Vt = {
				render: function() {
					...
					return a("div", {
						...
						staticClass: "tc ft30 au-statue"
					}, [t._v(t._s(t.$t("auth.certified")))]), t._v(" "), a("div", [a("span", [t._v(t._s(t.$t("ctc.name")) +
						"：")]), t._v(" "), a("span", [t._v(t._s(t.authData.name))])]), t._v(" "), a("div", [a("span", [t._v(t._s(
						t.$t("set.account")) + "：")]), t._v(" "), a("span", [t._v(t._s(t.authData.account))])]), t._v(" "), a(
						"div", [a("span", [t._v(t._s(t.$t("auth.idcard")) + "：")]), t._v(" "), a("span", [t._v(t._s(t.authData
							.card_id))])])])])])
				},
				staticRenderFns: []
			};
					...
					getNotice: function() {
						...
						this.$http({
							...
							if ("ok" == e.data.type) {
								...
								if (a.length > 0) {
									for (var s = [], i = 0; i < a.length; i++) a[i].c_id == t.datasId && s.push(a[i]);
									t.newList = s
								}
							}
						})
			...
			Kt = {
				render: function() {
					...
					return a("div", {
						...
						staticClass: "item"
					}, [a("h3", [t._v(t._s("18" == t.datasId ? t.$t("miscro.statement") : t.$t("miscro.about")))]), t._v(
						" "), a("ul", {
				...
				methods: {
					init: function() {
						...
						this.$http({
							...
							"ok" == t.data.type && (e.inviteCode = window.location.origin + "/mobile/register.html?code=" + t.data.message
								.extension_code, $("#code").qrcode({
									width: 120,
									height: 120,
									text: e.inviteCode
								}))
					...
					copy: function() {
						...
						e.on("success", function(e) {
							t.flags = !0, layer.msg(t.$t("set.copysuccess"))
			...
			te = {
				render: function() {
					...
					return a("div", {
						...
						}, [a("div", [a("p", [t._v(t._s(t.$t("miscro.myMine")) + t._s(t.datas.count))]), t._v(" "), a("p", [t._v(t
							._s(t.$t("miscro.friend")) + t._s(t.datas.sum))])]), t._v(" "), a("div", [a("p", [t._v(t._s(t.$t(
							"miscro.myRank")) + t._s(t.datas.level))]), t._v(" "), a("p", [t._v(t._s(t.$t("miscro.accumulated")) +
							t._s(t._f("numFilters")(t.datas.num || "0.00", 3)))])])]), t._v(" "), a("div", {
							staticClass: "tc"
						}, [a("div", {
							staticClass: "tc mt20",
							attrs: {
						...
						}, [a("h4", [t._v(t._s(t.$t("miscro.moneyVein")))]), t._v(" "), a("p", [t._v(t._s(t.newDetal.keyword))])]),
						t._v(" "), a("div", {
		...
		var ee = a("VU/8")($t, te, !1, function(t) {
			...
			ae = {
				...
				watch: {
					$route: function(t, e) {
						return this.id = t.query.id, this.init()
					}
				},
				created: function() {
					this.address = localStorage.getItem("token") || "", this.token = localStorage.getItem("token") || "", this.id =
				...
				methods: {
					init: function() {
						...
						this.$http({
							...
							"ok" === (e = e.data).type && (t.title = e.message.title, t.content = e.message.content, t.abstract = e.message
								.abstract, t.update_time = e.message.update_time, t.setProperty())
						}).catch(function(t) {})
					},
					goBefore: function() {
						this.$router.back(-1)
		...
		var ie = a("VU/8")(ae, se, !1, function(t) {
			...
			ne = {
				...
				beforeDestroy: function() {
					document.querySelector("html").removeAttribute("style"), document.getElementsByClassName("kefu")[0].removeAttribute(
						"style")
				},
				created: function() {
					this.token = localStorage.getItem("token") || "", this.init()
				},
				mounted: function() {
				...
				methods: {
					...
					submits: function() {
						this.texts ? this.$http({
							...
							t = t.data, layer.msg(t.message), "ok" === t.type && setTimeout(function() {
								location.reload()
							}, 1e3)
				...
				render: function() {
					...
					return a("div", {
						...
						return a("li", {
							...
							staticClass: "flex between"
						}, [a("p", [t._v(t._s(e.account_number))]), t._v(" "), a("p", [t._v(t._s(e.create_time))])]), t._v(
							" "), a("div", {
							staticClass: "mt10"
		...
		var oe = a("VU/8")(ne, re, !1, function(t) {
			...
			ce = {
				...
				created: function() {},
				mounted: function() {
					this.listId = this.$route.query.id, this.listCid = this.$route.query.cId, this.init(), this.getNewsList()
				},
				methods: {
					init: function() {
						var t = this;
					...
					linkDetail: function(t, e) {
						this.listId = t, this.listCid = e, this.init()
					}
				}
			},
			le = {
				render: function() {
					...
					return a("div", {
						...
						}, [t._v(t._s(t.$t("header.help")))]), t._v(" "), a("el-breadcrumb-item", [t._v(t._s(t.datas.title))])],
						1), t._v(" "), a("div", {
						...
						"span", [t._v(t._s(t.datas.update_time))])]), t._v(" "), a("div", {
		...
		var he = a("VU/8")(de, me, !1, function(t) {
			...
			pe = {
				...
				methods: {
					records: function(t, e) {
						this.currency = t, this.type = e, this.init()
					},
					init: function() {
						var t = this;
						this.$http({
					...
					selectType: function(t, e) {
						this.types = t, this.currency = e, "lever" == t ? (this.type = 0, this.list = this.financeData.lever_wallet.balance) :
							"micro" == t ? (this.type = 1, this.list = this.financeData.micro_wallet.balance) : "match" == t ? (this.type =
								2, this.list = this.financeData.change_wallet.balance) : "legal" == t && (this.type = 2, this.list = this.financeData
								.legal_wallet.balance), this.page = 1, this.init()
					},
					handleCurrentChange: function(t) {
						this.page = t, this.init()
					},
					transferBtn: function(t, e, a) {
						this.currencyName = t, this.currency = e, this.dialogVisible = !0, this.transferType = a, 2 == this.transferType ?
							this.availableBalance = this.legalAvailableBalance : this.availableBalance = this.leverAvailableBalance
					},
					tabClick: function() {
						this.transferType = 2 == this.transferType ? "1" : "2", 2 == this.transferType ? this.availableBalance = this
							.legalAvailableBalance : this.availableBalance = this.leverAvailableBalance
					},
					nums: function() {
					...
					transferSumbit: function() {
						var t = this,
							e = "",
							a = "";
						t.trasferNum ? (t.value1 == t.$t("asset.leverAccount") ? e = "lever" : t.value1 == t.$t("asset.miscroAccount") ?
							e = "micro" : t.value1 == t.$t("asset.flashAccount") ? e = "change" : t.value1 == t.$t(
								"asset.fince_account") && (e = "legal"), t.value2 == t.$t("asset.leverAccount") ? a = "lever" : t.value2 ==
							t.$t("asset.miscroAccount") ? a = "micro" : t.value2 == t.$t("asset.flashAccount") ? a = "change" : t.value2 ==
							t.$t("asset.fince_account") && (a = "legal"), t.dialogVisible = !1, this.$http({
								...
								layer.msg(e.data.message), "ok" == e.data.type && (t.trasferNum = "", setTimeout(function() {
					...
					selectedOne: function(t) {
						if ("lever" == t) {
							for (var e = 0, a = 0; a < this.accountList.length; a++) "lever" != this.accountList[a].type && (e = a);
							this.value1 = this.$t("asset.leverAccount");
							for (a = 0; a < this.currencyList.length; a++) this.currencyList[a].id == this.currency && (this.transferBalance =
								this.currencyList[a].wallet.lever_balance);
							this.value2 == this.$t("asset.leverAccount") && (this.value2 = this.accountList[e].texts)
						} else if ("micro" == t) {
							this.value1 = this.$t("asset.miscroAccount");
							for (e = 0, a = 0; a < this.accountList.length; a++) "micro" != this.accountList[a].type && (e = a);
							for (a = 0; a < this.currencyList.length; a++) this.currencyList[a].id == this.currency && (this.transferBalance =
								this.currencyList[a].wallet.micro_balance);
							this.value2 == this.$t("asset.miscroAccount") && (this.value2 = this.accountList[e].texts)
						} else if ("match" == t) {
							this.value1 = this.$t("asset.flashAccount");
							for (e = 0, a = 0; a < this.accountList.length; a++) "match" != this.accountList[a].type && (e = a);
							for (a = 0; a < this.currencyList.length; a++) this.currencyList[a].id == this.currency && (this.transferBalance =
								this.currencyList[a].wallet.change_balance);
							this.value2 == this.$t("asset.flashAccount") && (this.value2 = this.accountList[e].texts)
						} else if ("legal" == t) {
							this.value1 = this.$t("asset.fince_account");
							for (e = 0, a = 0; a < this.accountList.length; a++) "legal" != this.accountList[a].type && (e = a);
							for (a = 0; a < this.currencyList.length; a++) this.currencyList[a].id == this.currency && (this.transferBalance =
								this.currencyList[a].wallet.legal_balance);
					...
					selectedTwo: function(t) {
						if ("lever" == t) {
							...
							if (this.value1 == this.$t("asset.leverAccount")) {
								...
								for (a = 0; a < this.currencyList.length; a++) this.currencyList[a].id == this.currency && ("micro" == this
									.accountList[e].type ? this.transferBalance = this.currencyList[a].wallet.micro_balance : "match" == this
									.accountList[e].type ? this.transferBalance = this.currencyList[a].wallet.change_balance : "legal" ==
									this.accountList[e].type && (this.transferBalance = this.currencyList[a].wallet.legal_balance))
							}
						} else if ("micro" == t) {
							...
							if (this.value1 == this.$t("asset.miscroAccount")) {
								this.value1 = this.accountList[e].texts;
								for (a = 0; a < this.currencyList.length; a++) this.currencyList[a].id == this.currency && ("lever" == this
									.accountList[e].type ? this.transferBalance = this.currencyList[a].wallet.lever_balance : "match" == this
									.accountList[e].type ? this.transferBalance = this.currencyList[a].wallet.change_balance : "legal" ==
									this.accountList[e].type && (this.transferBalance = this.currencyList[a].wallet.legal_balance))
							}
						} else if ("match" == t) {
							...
							if (this.value1 == this.$t("asset.flashAccount")) {
								this.value1 = this.accountList[e].texts;
								for (a = 0; a < this.currencyList.length; a++) this.currencyList[a].id == this.currency && ("lever" == this
									.accountList[e].type ? this.transferBalance = this.currencyList[a].wallet.lever_balance : "micro" == this
									.accountList[e].type ? this.transferBalance = this.currencyList[a].wallet.micro_balance : "legal" == this
									.accountList[e].type && (this.transferBalance = this.currencyList[a].wallet.legal_balance))
							}
						} else if ("legal" == t) {
							...
							if (this.value1 == this.$t("asset.fince_account")) {
								...
								for (a = 0; a < this.currencyList.length; a++) this.currencyList[a].id == this.currency && ("lever" == this
									.accountList[e].type ? this.transferBalance = this.currencyList[a].wallet.lever_balance : "match" == this
									.accountList[e].type ? this.transferBalance = this.currencyList[a].wallet.change_balance : "micro" ==
									this.accountList[e].type && (this.transferBalance = this.currencyList[a].wallet.micro_balance))
							}
						}
					},
					selectedCurrency: function(t) {
						this.value3 = t.name, this.value3Id = t.id;
						for (var e = 0; e < this.currencyList.length; e++)
							if (this.currencyList[e].id == this.value3Id) {
								...
								this.accountList = a, this.value1 = this.accountList[0].texts, this.value2 = this.accountList[1].texts,
									"lever" == this.accountList[0].type ? this.transferBalance = this.currencyList[e].wallet.lever_balance :
									"match" == this.accountList[0].type ? this.transferBalance = this.currencyList[e].wallet.change_balance :
									"micro" == this.accountList[0].type ? this.transferBalance = this.currencyList[e].wallet.micro_balance :
									"legal" == this.accountList[0].type && (this.transferBalance = this.currencyList[e].wallet.legal_balance)
							}
					},
					copy: function() {
						var t = this,
					...
					chargeBtn: function(t, e) {
						var a = this;
						a.currencyName = t, a.currency = e, a.charge = !0, $("#code").html(""), this.$http({
					...
					withdrawBtn: function(t, e) {
						var a = this;
						a.currencyName = t, a.currency = e, a.withdraw = !0, this.$http({
							...
							"ok" == t.data.type && (a.withdrawRate = t.data.message.rate, a.withdrawTotal = t.data.message.legal_balance,
								a.pala = a.$t("asset.minnum") + t.data.message.min_number)
						}).catch(function(t) {})
					},
					withdrawSumbit: function() {
						return this.withdrawAddress ? this.withdrawNUm ? void this.$http({
							...
							layer.msg(t.data.message), "ok" == t.data.type && setTimeout(function() {
								window.location.reload()
							}, 1e3)
						}).catch(function(t) {}) : (layer.msg(this.$t("asset.enterNum")), !1) : (layer.msg(this.$t(
							"asset.enterAdderses")), !1)
					}
				},
				created: function() {
					this.token = localStorage.getItem("token") || ""
				...
				mounted: function() {
					...
					e.on("success", function(e) {
					...
					}), e.on("error", function(t) {}), this.$http({
						url: "/api/wallet/list",
						method: "post",
						data: {},
						headers: {
						...
						if ("ok" == e.data.type) {
							t.leverBalance = e.data.message.lever_wallet.totle, t.legalBalance = e.data.message.legal_wallet.totle, t.microBalance =
								e.data.message.micro_wallet.totle, t.matchBalance = e.data.message.change_wallet.totle, t.list = e.data.message
								.lever_wallet.balance, t.status = e.data.message.is_open_CTbi, t.financeData = e.data.message, t.balances =
								t.list[0].lever_balance;
							for (var a = 0; a < e.data.message.lever_wallet.balance.length; a++) 1 == e.data.message.lever_wallet.balance[
								a].is_lever && (t.currency = e.data.message.lever_wallet.balance[a].currency);
							t.init()
						}
					}).catch(function(t) {}), this.$http({
						...
						if ("ok" == e.data.type) {
							...
							if (a.length > 0) {
								...
								t.value3 = s[0].name, t.value3Id = s[0].id;
								var n = [];
								if (1 == s[0].is_legal) {
									var r = {
										type: "legal",
								...
								t.accountList = n, t.currencyList = s, t.value1 = n[0].texts, t.value2 = n[1].texts, "lever" == n[0].type ?
									t.transferBalance = s[0].wallet.lever_balance : "micro" == n[0].type ? t.transferBalance = s[0].wallet.micro_balance :
									"match" == n[0].type ? t.transferBalance = s[0].wallet.change_balance : "legal" == n[0].type && (t.transferBalance =
										s[0].wallet.legal_balance)
							}
							t.init()
						}
					}).catch(function(t) {})
			...
			ge = {
				render: function() {
					...
					return a("div", {
					...
					}), t._v(" "), a("p", [t._v(t._s(t.$t("miscro.contractValuation")))]), t._v(" "), a("p", [t._v(t._s(t.leverBalance) +
						"（CNY）")])]), t._v(" "), a("div", {
						staticClass: "flex"
					}, [a("p", {
						staticClass: "second-circle"
					}), t._v(" "), a("p", [t._v(t._s(t.$t("miscro.secondValuation")))]), t._v(" "), a("p", [t._v(t._s(t.microBalance) +
						"（CNY）")])]), t._v(" "), a("div", {
						staticClass: "flex"
					}, [a("p", {
						staticClass: "miscro-circle"
					}), t._v(" "), a("p", [t._v(t._s(t.$t("miscro.falshValuation")))]), t._v(" "), a("p", [t._v(t._s(t.matchBalance) +
						"（CNY）")])]), t._v(" "), a("div", {
						staticClass: "flex"
					}, [a("p", {
						staticClass: "legal-circle"
					}), t._v(" "), a("p", [t._v(t._s(t.$t("miscro.c2cValuation")))]), t._v(" "), a("p", [t._v(t._s(t.legalBalance) +
						"（CNY）")])])]), t._v(" "), a("div", {
						staticClass: "content"
					}, [a("div", {
						...
						staticClass: "flex"
					}, [a("p", [t._v(t._s(t.$t("asset.currency")))]), t._v(" "), a("p", [t._v(t._s(t.$t("asset.canuse")))]),
						t._v(" "), a("p", [t._v(t._s(t.$t("asset.frezz")))]), t._v(" "), a("p", [t._v(t._s(t.$t(
							"asset.conversion")) + "(CNY)")]), t._v(" "), a("div")
					]), t._v(" "), t._l(t.list, function(e) {
						return "lever" == t.types && 1 == e.is_lever ? a("li", {
							key: e.id,
							staticClass: "flex"
						}, [a("p", [t._v(t._s(e.currency_name))]), t._v(" "), a("p", [t._v(t._s(e.lever_balance))]), t._v(
							" "), a("p", [t._v(t._s(e.lock_lever_balance))]), t._v(" "), a("p", [t._v(t._s(t._f("numFilters")
							(e.lever_balance * e.cny_price, 4)))]), t._v(" "), a("div", {
							staticClass: "btns"
						}, [a("button", {
							attrs: {
								type: "button"
						...
						return "micro" == t.types && 1 == e.is_micro ? a("li", {
							key: e.id,
							staticClass: "flex"
						}, [a("p", [t._v(t._s(e.currency_name))]), t._v(" "), a("p", [t._v(t._s(e.micro_balance))]), t._v(
							" "), a("p", [t._v(t._s(e.lock_micro_balance))]), t._v(" "), a("p", [t._v(t._s(t._f("numFilters")
							(e.micro_balance * e.cny_price, 4)))]), t._v(" "), a("div", {
							staticClass: "btns"
						...
						return "match" == t.types && 1 == e.is_match ? a("li", {
							key: e.id,
							staticClass: "flex"
						}, [a("p", [t._v(t._s(e.currency_name))]), t._v(" "), a("p", [t._v(t._s(e.change_balance))]), t._v(
							" "), a("p", [t._v(t._s(e.lock_change_balance))]), t._v(" "), a("p", [t._v(t._s(t._f("numFilters")
							(e.change_balance * e.cny_price, 4)))]), t._v(" "), a("div", {
							staticClass: "btns"
						}, [a("button", {
							attrs: {
								type: "button"
						...
						return "legal" == t.types && 1 == e.is_legal ? a("li", {
							key: e.id,
							staticClass: "flex"
						}, [a("p", [t._v(t._s(e.currency_name))]), t._v(" "), a("p", [t._v(t._s(e.legal_balance))]), t._v(
							" "), a("p", [t._v(t._s(e.lock_legal_balance))]), t._v(" "), a("p", [t._v(t._s(t._f("numFilters")
							(e.legal_balance * e.cny_price, 4)))]), t._v(" "), a("div", {
							staticClass: "btns"
						}, [a("button", {
							attrs: {
								type: "button"
					...
					}, [a("li", [t._v("* " + t._s(t.$t("asset.a01")) + t._s(t.currencyName) + t._s(t.$t("asset.a02")) +
						t._s(t.$t("asset.a03")))]), t._v(" "), a("li", [t._v("* " + t._s(t.$t("asset.a06")) + "100" + t._s(
						t.currencyName) + "。")]), t._v(" "), a("li", [t._v("* " + t._s(t.$t("asset.a10")))]), t._v(" "), a(
						"li", [t._v("* " + t._s(t.$t("asset.a11")))])])])])]), t._v(" "), a("el-dialog", {
						attrs: {
							title: "",
							visible: t.withdraw,
							width: "400px",
						...
						staticClass: "transfer-right"
					}, [t._v(t._s(t._f("numFilters")(t.withdrawNUm - t.withdrawRate > 0 ? t.withdrawNUm - t.withdrawRate :
						"0.00", 8)) + " " + t._s(t.currencyName))])])])]), t._v(" "), a("span", {
						staticClass: "dialog-footer",
						attrs: {
							slot: "footer"
						},
				...
				methods: {
					getinfo: function() {
						...
						t.$http({
							...
							"ok" == e.data.type && (t.datas = e.data.message, t.leftList = e.data.message.left, t.rightList = e.data.message
								.right, t.value1 = e.data.message.left[0].name, t.leftLogo = e.data.message.left[0].logo, t.value2 = e.data
								.message.right[0].name, t.rightLogo = e.data.message.right[0].logo, t.prices = e.data.message.left[0].price,
								t.maxNumber = e.data.message.left[0].max_number, t.minNumber = e.data.message.left[0].min_number, t.leftId =
								e.data.message.left[0].id, t.rightId = e.data.message.right[0].id, t.balance = e.data.message.left[0].balance,
								t.priceFub = e.data.message.left[0].to_pb_price)
						}).catch(function(t) {})
					},
					getList: function() {
						var t = this;
					...
					selectedOne: function(t) {
						this.value1 = t.name, this.leftId = t.id, this.leftLogo = t.logos, this.prices = t.prices, this.maxNumber = t
							.maxNUm, this.minNumber = t.minNUm, this.balance = t.balances, this.priceFub = t.pbPrice
					},
					selectedTwo: function(t) {
						this.value2 = t.name, this.rightId = t.id, this.rightLogo = t.logos
					},
					coinTab: function() {
						this.typeTab = 1 == this.typeTab ? 2 : 1, 1 == this.typeTab ? (this.leftList = this.datas.left, this.rightList =
							this.datas.right, this.value1 = this.datas.left[0].name, this.leftLogo = this.datas.left[0].logo, this.value2 =
							this.datas.right[0].name, this.rightLogo = this.datas.right[0].logo, this.prices = this.datas.left[0].price,
							this.maxNumber = this.datas.left[0].max_number, this.minNumber = this.datas.left[0].min_number, this.leftId =
							this.datas.left[0].id, this.rightId = this.datas.right[0].id, this.balance = this.datas.left[0].balance,
							this.priceFub = this.datas.left[0].to_pb_price) : (this.leftList = this.datas.right, this.rightList = this.datas
							.left, this.value1 = this.datas.right[0].name, this.leftLogo = this.datas.right[0].logo, this.value2 = this
							.datas.left[0].name, this.rightLogo = this.datas.left[0].logo, this.prices = this.datas.right[0].price,
							this.maxNumber = this.datas.left[0].max_number, this.minNumber = this.datas.left[0].min_number, this.leftId =
							this.datas.right[0].id, this.rightId = this.datas.left[0].id, this.balance = this.datas.right[0].balance,
							this.priceFub = this.datas.right[0].to_pb_price)
					},
					sumbit: function() {
						if (!this.inputPrice) return layer.msg(this.$t("lever.pprice")), !1;
						if (!this.inputNUm) return layer.msg(this.$t("fat.pnums")), !1;
						var t = layer.load();
						this.$http({
							...
							layer.close(t), layer.msg(e.data.message), "ok" == e.data.type && setTimeout(function() {
								location.reload()
							}, 1e3)
						}).catch(function(t) {})
					}
				...
				render: function() {
					...
					return s("div", {
						...
						return s("li", {
							...
							staticClass: "width1"
						}, [t._v(t._s(e.l_currency) + t._s(t.$t("miscro.match")) + t._s(e.r_currency))]), t._v(" "), s(
							"p", {
								staticClass: "width2"
		...
		var _e = a("VU/8")(fe, ye, !1, function(t) {
			...
			be = {
				...
				mounted: function() {
					this.init(), this.getList(), this.getInsuranceType(), this.insuranceMoney()
				},
				methods: ht()({
					...
					init: function() {
						...
						"exchange" == t.tradeType && (t.$http({
							...
							if ("ok" == e.data.type) {
								...
								t.usdtRate = "1:" + a.usdt_bmb_proportion, t.bmbRate = s + ":1", t.rate = t.usdtRate, t.usdtFee = a.usdt_bmb_fee,
									t.bmbFee = a.bmb_usdt_fee, t.fee = t.usdtFee, t.usdtBalance = a.user_balance, t.bmbBalance = a.bmb_balance,
									t.balance = t.usdtBalance, t.bmbProportion = a.bmb_usdt_proportion, t.usdtProportion = a.usdt_bmb_proportion,
							...
							if ("ok" == e.data.type) {
								for (var a = e.data.message, s = 0; s < a.length; s++) "USDT" == a[s].name ? t.usdtId = a[s].id :
									"AITB" == a[s].name && (t.bmbId = a[s].id);
								t.formCurrencyId = t.usdtId, t.toCurrencyId = t.bmbId
							}
						}).catch(function(t) {}))
					},
					getList: function() {
						...
						t.$http({
							...
							"ok" == e.data.type && (t.total1 = e.data.message.total, e.data.message.data.length > 0 && (t.moreText =
								t.$t("td.more"), t.list = e.data.message.data))
						}).catch(function(t) {})
					},
					coinTab: function() {
						this.typeTab = 1 == this.typeTab ? 2 : 1, this.inputNUm = "", this.inputPrice = "", 1 == this.typeTab ? (
							this.leftValue = "USDT", this.rightValue = "AITB", this.rate = this.usdtRate, this.fee = this.usdtFee,
							this.balance = this.usdtBalance, this.formCurrencyId = this.usdtId, this.toCurrencyId = this.bmbId, this.proportion =
							this.usdtProportion) : (this.leftValue = "AITB", this.rightValue = "USDT", this.rate = this.bmbRate, this
							.fee = this.bmbFee, this.balance = this.bmbBalance, this.formCurrencyId = this.bmbId, this.toCurrencyId =
							this.usdtId, this.proportion = this.bmbProportion)
					},
					inputs: function() {
						this.rate.split(":");
						this.inputNUm = this.$utils.filterDecimals((this.inputPrice - 0) * (100 - this.fee) / 100 * (this.proportion -
							0), 4)
					},
						...
						t.$http({
							...
							if ("ok" == e.data.type) {
								var a = e.data.message.currency,
									s = [];
								if (a.length > 0) {
									for (var i = 0; i < a.length; i++) 1 == a[i].insurancable && s.push(a[i]);
									t.currencyList = s, t.insuranceCurrencyId = s[0].id, t.insuranceCurrencyName = s[0].name, t.getUserInsurance()
								}
							}
						}).catch(function(t) {})
					},
					getUserInsurance: function() {
						...
						t.$http({
							...
							"ok" == e.data.type && (t.currencyBalnace = e.data.message.user_wallet.micro_balance, t.insuranceBalnce =
								e.data.message.user_wallet.insurance_balance, t.InsuranceAssets = e.data.message.user_wallet.lock_insurance_balance,
								e.data.message.user_insurance && e.data.message.user_insurance.id ? (t.insuranceNum = e.data.message.user_insurance
									.amount / 1e4, t.disabledStatu = !0, t.insuranceAssets = e.data.message.user_insurance.insurance_amount /
									e.data.message.user_insurance.amount * 100, t.insuranceType = e.data.message.user_insurance.insurance_type_id,
									t.userInsuranceId = e.data.message.user_insurance.id) : (t.insuranceNum = "", t.disabledStatu = !1),
								t.$http({
									...
									if ("ok" == e.data.type) {
										...
										for (var a = 0; a < e.data.message.length; a++) "反向险" == e.data.message[a].name && (t.multi = e.data
											.message[a].claim_rate / 100, t.profit = e.data.message[a].profit_termination_condition);
										if (t.insuranceType)
											for (a = 0; a < e.data.message.length; a++) t.insuranceType == e.data.message[a].id && (t.insuranceText =
												e.data.message[a].name, t.insuranceMin = e.data.message[a].min_amount / 1e4, t.insuranceMax = e.data
												.message[a].max_amount / 1e4, t.pla = t.insuranceMin + "≤" + t.$t("fat.pnums") + "≤" + t.insuranceMax,
												t.insuranceAssets = e.data.message[a].insurance_assets);
										else t.insuranceText = e.data.message[0].name, t.insuranceMin = e.data.message[0].min_amount / 1e4,
											t.insuranceMax = e.data.message[0].max_amount / 1e4, t.pla = t.insuranceMin + "≤" + t.$t(
												"fat.pnums") + "≤" + t.insuranceMax, t.insuranceType = e.data.message[0].id, t.insuranceAssets =
											e.data.message[0].insurance_assets
									}
								}).catch(function(t) {}))
						}).catch(function(t) {})
					},
					selectedCurrency: function(t) {
						this.insuranceCurrencyId = t.id, this.insuranceCurrencyName = t.name, this.getUserInsurance()
					},
					selectedOne: function(t) {
						this.insuranceType = t.id, this.insuranceText = t.name, this.insuranceMin = t.min_amount / 1e4, this.insuranceMax =
							t.max_amount / 1e4, this.pla = this.insuranceMin + "≤" + this.$t("fat.pnums") + "≤" + this.insuranceMax,
					...
					purchaseInsurance: function() {
						var t = this,
							...
							a = "";
						if (!t.insuranceNum) return layer.msg(t.$t("fat.pnums")), !1;
						if (e - 0 > t.currencyBalnace - 0) return layer.msg(t.$t("miscro.runningLow")), !1;
						if (t.insuranceNum < t.insuranceMin || t.insuranceNum > t.insuranceMax) return layer.msg(t.$t(
								"miscro.purchase") + t.insuranceMin + t.$t("miscro.reach") + t.insuranceMax + t.$t("miscro.between")), !
							1;
						if (t.insuranceNum % 1 != 0) return layer.msg(t.$t("miscro.onlyEnter") + t.insuranceMin + "-" + t.insuranceMax +
							t.$t("miscro.integersBetween")), !1;
						a = "正向险" == t.insuranceText ? t.$t("miscro.notReturned") : t.$t("miscro.settled") + t.multi + t.$t(
							"miscro.profitable") + t.profit + "%" + t.$t("miscro.terminated");
						...
						g.a.alert(a, "", {
							...
							callback: function(e) {
								"confirm" == e && t.$http({
									...
									layer.msg(e.data.message), "ok" == e.data.type && t.getInsuranceType()
								}).catch(function(t) {})
							}
						})
					},
					...
					selectedTwo: function(t) {
						this.value2 = t.name, this.rightId = t.id, this.rightLogo = t.logos, 2 == this.typeTab && (this.prices = t.prices,
							this.maxNumber = t.maxNUm, this.minNumber = t.minNUm, this.balance = t.balances)
					},
					mores: function() {
					...
					sumbit1: function() {
						var t = this;
						return t.inputPrice ? 2 == t.typeTab && t.inputPrice - 0 < 100 ? (layer.msg(t.$t("miscro.lowestNumber") +
							"100"), !1) : void g.a.alert(t.$t("miscro.confirmExchange"), "", {
							confirmButtonText: t.$t("cuy.confirm"),
							customClass: "modalConfirm",
							confirmButtonClass: "confirmBtn",
							closeOnClickModal: !0,
					...
					insuranceMoney: function() {
						...
						}).catch(function(t) {}), t.insuranceMoneyList()
					},
					insuranceMoneyList: function() {
						...
						t.$http({
							...
							if ("ok" == e.data.type) {
								...
								t.moneyTotal = e.data.message.total, a.length > 0 ? t.moneyList = t.moneyList.concat(a) : t.pages
							}
						}).catch(function(t) {})
					}
				}, "handleCurrentChange", function(t) {
					this.pages = t, this.insuranceMoneyList()
				})
			},
			Ce = {
				render: function() {
					...
					return s("div", {
						class: "days" == t.skins ? "exchange" : "exchange balck"
							...
							staticClass: "convertibility-header flex between"
								...
								staticClass: "tl"
							}, [s("p", [t._v(t._s(t.$t("miscro.currencyExchange")))]), t._v(" "), s("p", [t._v(t._s(t.leftValue))])]),
							t._v(" "), s("img", {
								staticClass: "tab-logo",
								attrs: {
									src: a("t8iL"),
								...
								staticClass: "tl"
							}, [s("p", [t._v(t._s(t.$t("miscro.currencyExchangeIn")))]), t._v(" "), s("p", [t._v(t._s(t.rightValue))])])
						]), t._v(" "), s("div", {
							staticClass: "content flex between"
						}, [s("input", {
							directives: [{
							...
							staticClass: "tc mt10"
						}, [t._v(t._s(t.$t("td.nodata")))]) : t._e()], 1)]) : t._e(), t._v(" "), "insurance" == t.tradeType ? s(
							"div", {
								staticClass: "top"
							}, [s("div", {
								staticClass: "convertibility-header flex between"
							...
							}), t._v(" "), s("span", [t._v(t._s(t.$t("miscro.tenThousand")))])]), t._v(" "), s("div")]), t._v(" "), s(
								"div", {
							...
							}, [t._v(t._s(t.$t("miscro.insuranceCancellation")))])])]) : t._e(), t._v(" "), "rawCurrency" == t.tradeType ?
						s("div", {
							staticClass: "top"
						}, [s("div", {
							staticClass: "convertibility-header flex between"
							...
							staticClass: "mt10"
						}, [t._v(t._s(t.$t("miscro.availableQuantity")) + t._s(t.moneyData.usabled_balance))])])]) : t._e(), t._v(
							" "), "rawCurrency" == t.tradeType ? s("div", {
							staticClass: "btm"
						}, [s("div", {
							staticClass: "order-list"
						}, [s("p", {
		...
		var Ae = a("VU/8")(be, Ce, !1, function(t) {
			...
			we = {
				...
				created: function() {
					this.token = localStorage.getItem("token") || "", this.currency = this.$route.query.currency_id
				},
				mounted: function() {
					this.init(), this.legal_log()
				},
				methods: {
					init: function() {
						var t = this;
						this.$http({
							...
							if ("ok" == e.data.type) {
								var a = e.data.message;
								t.legal_name = a.currency_name, t.legal_balance = a.legal_balance, t.lock_legal_balance = a.lock_legal_balance,
					...
					getMore: function() {
						this.page = this.page + 1, this.legal_log()
					}
				}
			},
			ke = {
				render: function() {
					...
					return a("div", {
						...
						staticClass: "ft12 msg_title"
					}, [t._v(t._s(t.$t("asset.conversion")) + "（CNY）")]), t._v(" "), a("p", [t._v(t._s(t._f("numFilters")(t
						.cny_price, 8)))])])]), t._v(" "), a("div", {
		...
		var Ie = a("VU/8")(we, ke, !1, function(t) {
			...
			Se = {
				...
				created: function() {
					this.init(), 0 != this.status && 1 != this.status || this.polling()
				},
				beforeCreate: function() {
					document.querySelector("html").setAttribute("style", "background-color:#f7f7f7;")
				},
				...
				methods: {
					init: function() {
						...
						if (t.more = t.$t("lever.loading"), t.flag) {
							...
							this.$http({
								...
								layer.close(e), t.flag = !0, "ok" == a.data.type ? (t.more = t.$t("td.more"), t.list_content = a.data.message
									.message.data, t.total = a.data.message.message.total) : layer.msg(a.data.message)
							}).catch(function(t) {})
						}
					},
					polling: function() {
					...
					tabClick: function(t) {
						this.status = t, this.list_content = [], this.page = 1, this.init(), this.flag = !1, 0 != t && 1 != t || this
							.polling()
					},
						...
						g.a.alert(e.$t("lever.revokeOrder"), "", {
							...
							callback: function(a) {
								"confirm" == a && e.$http({
									...
									layer.close(i), "ok" == t.data.type ? (layer.msg(t.data.message), setTimeout(function() {
										e.tabClick(e.status)
					...
					return a("div", {
						...
						return a("li", {
							...
							staticClass: "flex alcenter center"
								...
								staticClass: "width2"
							}, [t._v(t._s(1 == e.type ? t.$t("td.buyin") : t.$t("td.sellout")) + " " + t._s(e.symbol) + " x" +
								t._s(e.share) + "(No." + t._s(e.id) + ")")]), t._v(" "), 0 == t.status || 4 == t.status ? a("span", {
								staticClass: "width1"
							...
							}, [t._v(t._s(t._f("numFilters")(e.profits || "0.00", 4)))]), t._v(" "), 0 == t.status || 1 == t.status ?
							a("div", {
		...
		var xe = a("VU/8")(Se, Be, !1, function(t) {
				a("va/8")
			...
			Pe = {
				render: function() {
					...
					}, [a("span", [t._v(t._s(t.$t("fat.type")))]), t._v(" "), a("span", [t._v(t._s(t.$t("td.num")))]), t._v(
						" "), a("span", [t._v(t._s(t.$t("td.time")))])]), t._v(" "), a("ul", t._l(t.log, function(e, s) {
						return a("li", {
							key: s
						}, [a("span", [t._v(t._s(e.type))]), t._v(" "), a("span", [t._v(t._s(e.number || "0.00"))]), t._v(
							" "), a("span", [t._v(t._s(e.add_time))])])
					}))])])
				},
				staticRenderFns: [function() {
					var t = this.$createElement,
			...
			Te = {
				...
				methods: {
							...
							"" != e.account_number ? ("mobile" == e.isMb ? (s = "sms_send", a = {
								...
								if (layer.msg(a.data.message), "ok" == a.data.type) {
									...
									i = setInterval(function() {
										if (t.target.innerHTML = s + e.$t("fat.second"), t.target.disabled = !0, 0 == s) return clearInterval(
											i), t.target.innerHTML = e.$t("set.code"), void(t.target.disabled = !1);
										s--
									}, 1e3)
								}
					...
					check: function() {
						...
						if ("" != e)
							if ("" != this.phoneCode) {
								if (-1 != e.indexOf("@")) s = "user/check_email", i.email_code = this.phoneCode;
								else {
									if (!a) return void layer.tips(t.$t("set.accountFalse"), "#account");
									s = "user/check_mobile", i.mobile_code = this.phoneCode
								}
								this.$http({
									url: "/api/" + s,
									method: "post",
									...
									layer.msg(e.data.message), "ok" == e.data.type && (localStorage.setItem("forgetAccount", t.account_number),
										localStorage.setItem("forgetCode", t.phoneCode), setTimeout(function() {
											t.$router.push({
												path: "/ResetPwd",
												query: {
													areaId: t.areaId,
							...
							} else layer.tips(t.$t("set.enterCode"), "#pwd");
						else layer.tips(t.$t("set.enterAccount"), "#account")
					},
					resetPass: function() {
						var t = this;
						if ("" != this.password)
							if ("" != this.re_password)
								if (this.password === this.re_password) {
									...
									this.$http({
										...
										layer.msg(e.data.message), "ok" == e.data.type && t.$router.push("/components/login")
									})
								} else layer.msg(this.$t("set.pswFalse"));
						else layer.msg(this.$t("set.enterPswagain"));
						else layer.msg(this.$t("set.enterPsw"))
					},
					tabSelect: function(t) {
						this.isMb = t, this.account_number = "", this.phoneCode = ""
					},
					getCity: function(t, e) {
						this.areaCode = e, this.areaId = t, this.showCity = !1
					}
		...
		var De = a("VU/8")(Te, Ne, !1, function(t) {
			...
			Qe = {
				...
				created: function() {
					this.areaCode = this.$route.query.areaCode, this.areaId = this.$route.query.areaId
				},
				beforeCreate: function() {
		...
		var Re = a("VU/8")(Qe, Me, !1, function(t) {
				a("b0kE")
							...
							if ("" != this.account_number)
								if (/^([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+\.[a-zA-Z]{2,3}$/.test(
									...
									s = setInterval(function() {
										if (t.target.innerHTML = a + e.$t("fat.second"), t.target.disabled = !0, 0 == a) return clearInterval(s),
											t.target.innerHTML = e.$t("set.code"), void(t.target.disabled = !1);
										a--
									}, 1e3)
								} else layer.tips("您输入的邮箱账号不符合规则!", "#account");
							else layer.tips(this.$t("register.enterEmail"), "#account")
						}
					},
					check: function() {
						var t = this,
						...
						"" != e ? "" != this.phoneCode ? (a.code = this.phoneCode, a.email = e, this.$http({
							...
							layer.msg(e.data.message), "ok" == e.data.type && t.$router.go(-1)
		...
		var je = a("VU/8")(Je, Ze, !1, function(t) {
			a("YKFw")
		...
		let We = {
			...
			host: "http://jys.wenzhen166.com/",
			laravel_api: "http://jys.wenzhen166.com/api/",
			node_api: "http://jys.wenzhen166.com:3000/",
			socket_api: "http://jys.wenzhen166.com:2120/",
		...
		var Ve, He, qe, Ke, Xe, $e, ta, ea, aa = {
			...
			pa = {
				...
				lg: {
					...
					login18: "畅通的信息渠道",
					login19: "丰富的社群活动",
					login20: "Demo精英团队由高级金融工程师，业界专业IT人士，资深区块链架构师组成。在“金融衍生品设计”、",
				...
				fat: (Ve = {
						...
						shoperZname: "商家支行",
						shoperNum: "商家账户"
					}, ht()(Ve, "odCeil", "取消订单"), ht()(Ve, "imPay", "我已付款,点击确认"), ht()(Ve, "register_time", "注册时间"), ht()(Ve,
						"odtotal", "总成单"), ht()(Ve, "odmonth", "30日成单"), ht()(Ve, "odfinish", "完成单"), ht()(Ve, "odrate", "完成率"), ht()
					(Ve, "submit", "发布"), ht()(Ve, "phone", "手机"), ht()(Ve, "email", "邮箱"), ht()(Ve, "mysell", "我的出售"), ht()(Ve,
						"mybuy", "我的求购"), ht()(Ve, "realAuth", "实名认证"), ht()(Ve, "advAuth", "高级认证"), ht()(Ve, "linebuy", "在线购买"), ht()
					(Ve, "linesell", "在线出售"), ht()(Ve, "tipPay", "请在24小时内联系商家付款，超出24小时将自动取消"), ht()(Ve, "notlow", "不能低于最低限额"), ht()
					(Ve, "nothigh", "不能超出最大限额"), ht()(Ve, "notnum", "不能超出最大数量"), ht()(Ve, "type", "类型"), ht()(Ve, "status", "状态"),
					ht()(Ve, "seeOrder", "查看订单"), ht()(Ve, "withdraw", "撤回"), ht()(Ve, "abnormal", "异常"), ht()(Ve, "psType",
						"请选择类型"), ht()(Ve, "pselect", "请选择"), ht()(Ve, "alipay", "支付宝"), ht()(Ve, "wechat", "微信"), ht()(Ve, "bank",
						"银行卡"), ht()(Ve, "minNum", "最小交易数量"), ht()(Ve, "maxNum", "最大交易数量"), ht()(Ve, "wantBuy", "求购"), ht()(Ve,
						"pnums", "请输入数量"), ht()(Ve, "pmin", "请输入最小交易量"), ht()(Ve, "pmax", "请输入最大交易量"), ht()(Ve, "pnot",
						"最大交易量不能小于最小交易量"), ht()(Ve, "myshops", "我的店铺"), ht()(Ve, "name", "名称"), ht()(Ve, "fiatSub", "所属法币"), ht()(Ve,
						"shoper_balance", "商家余额"), ht()(Ve, "enterShop", "进入店铺"), ht()(Ve, "payedWait", "已付款，等待核实后确认"), ht()(Ve,
						"completeOrder", "商家已完成单"), ht()(Ve, "tradeCurrency", "交易币种"), ht()(Ve, "closeBtn", "关闭"), ht()(Ve, "QRcode",
						"支付二维码"), ht()(Ve, "imgUp", "图片上传失败"), ht()(Ve, "please", "请于"), ht()(Ve, "Introvert", "内向"), ht()(Ve,
						"payment", "付款"), ht()(Ve, "hour", "时"), ht()(Ve, "minute", "分"), ht()(Ve, "second", "秒"), Ve),
				ctc: {
					ctc: "C2C",
					myRelease: "我发布的C2C",
					myTrade: "我交易的C2C",
				...
				set: (He = {
					...
					code: "验证码",
					getCode: "获取验证码"
				}, ht()(He, "setPsw", "设置密码"), ht()(He, "enterPsw", "请输入密码"), ht()(He, "pswFalse", "两次输入的密码不一致"), ht()(He,
					"enterPswagain", "请再次输入密码"), ht()(He, "enterAccount", "请输入账号"), ht()(He, "enterCode", "请输入验证码"), ht()(He,
					"accountFalse", "您输入的手机或邮箱账号不符合规则!"), ht()(He, "second", "秒"), ht()(He, "sendCode", "发送验证码"), ht()(He,
					"enterPswTwo", "请输入两次密码"), ht()(He, "rest", "剩余"), ht()(He, "verification", "手机验证"), He),
				auth: {
					identity: "身份认证",
					name: "姓名",
					idcard: "身份证号",
			...
			ga = {
				...
				fat: (qe = {
					...
					}, ht()(qe, "odCeil", "Cancel order"), ht()(qe, "imPay", "have paid, Confirm"), ht()(qe, "register_time",
						"Register time"), ht()(qe, "odtotal", "Assembly sheet"), ht()(qe, "odmonth", "30 days sheet"), ht()(qe,
						"odfinish", "Completion sheet"), ht()(qe, "odrate", "Completion rate"), ht()(qe, "submit", "publish"), ht()(
						qe, "phone", "phone"), ht()(qe, "email", "mailbox"), ht()(qe, "mysell", "My sale"), ht()(qe, "mybuy",
						"My purchase"), ht()(qe, "realAuth", "Real name authentication"), ht()(qe, "advAuth",
						"Advanced authentication"), ht()(qe, "linebuy", "Online purchase"), ht()(qe, "linesell", "Sell online"), ht()
					(qe, "tipPay",
						"Please contact the merchant for payment within 24 hours. If the payment exceeds 24 hours, it will be cancelled automatically."
					), ht()(qe, "notlow", "No less than the minimum limit"), ht()(qe, "nothigh", "Do not exceed the maximum limit"),
					ht()(qe, "notnum", "Do not exceed the maximum quantity"), ht()(qe, "type", "type"), ht()(qe, "status",
						"status"), ht()(qe, "seeOrder", "View order"), ht()(qe, "withdraw", "withdraw"), ht()(qe, "abnormal",
						"abnormal"), ht()(qe, "psType", "Please select the type"), ht()(qe, "pselect", "Please choose"), ht()(qe,
						"alipay", "Alipay"), ht()(qe, "wechat", "WeChat"), ht()(qe, "bank", "Bank card"), ht()(qe, "minNum",
						"Minimum trading volume"), ht()(qe, "maxNum", "Maximum trading volume"), ht()(qe, "wantBuy", "want to buy"),
					ht()(qe, "pnums", "Please enter quantity"), ht()(qe, "pmin", "Please enter the minimum transaction volume"),
					ht()(qe, "pmax", "Please enter the maximum trading volume"), ht()(qe, "pnot",
						"Maximum trading volume should not be less than minimum trading volume"), ht()(qe, "myshops",
						"personal stores"), ht()(qe, "name", "Name"), ht()(qe, "fiatSub", "Legal tender"), ht()(qe, "shoper_balance",
						"Merchant balance"), ht()(qe, "enterShop", "Enter shop"), ht()(qe, "payedWait",
						"Payment made awaiting verification"), ht()(qe, "completeOrder", "Completed the order"), ht()(qe,
						"tradeCurrency", "Currency Of Transaction"), ht()(qe, "closeBtn", "Close"), ht()(qe, "QRcode",
						"Payment QR code"), ht()(qe, "imgUp", "Picture upload failed"), ht()(qe, "please", "Please"), ht()(qe,
						"Introvert", "Introvert"), ht()(qe, "payment", "payment"), ht()(qe, "hour", "hour"), ht()(qe, "minute",
				...
				set: (Ke = {
						...
						getCode: "Get code"
					}, ht()(Ke, "setPsw", "set password"), ht()(Ke, "enterPsw", "Please enter a password"), ht()(Ke, "pswFalse",
						"The passwords entered twice are inconsistent"), ht()(Ke, "enterPswagain", "Please enter your password again"),
					ht()(Ke, "enterAccount", "Please enter an account"), ht()(Ke, "enterCode",
						"Please enter the verification code"), ht()(Ke, "accountFalse",
						"The phone or email account you entered does not meet the rules!"), ht()(Ke, "second", "second"), ht()(Ke,
						"sendCode", "send"), ht()(Ke, "enterPswTwo", "Please enter the password twice"), ht()(Ke, "rest", "remaining"),
					ht()(Ke, "verification", "Mobile phone verification"), Ke),
				auth: {
			...
			va = {
				...
				fat: (Xe = {
						...
						shoperZname: "商家支行",
						shoperNum: "商家賬戶"
					}, ht()(Xe, "odCeil", "取消訂單"), ht()(Xe, "imPay", "我已付款,點擊確認"), ht()(Xe, "register_time", "註冊時間"), ht()(Xe,
						"odtotal", "總成單"), ht()(Xe, "odmonth", "30日成單"), ht()(Xe, "odfinish", "完成單"), ht()(Xe, "odrate", "完成率"), ht()
					(Xe, "submit", "發布"), ht()(Xe, "phone", "手機"), ht()(Xe, "email", "郵箱"), ht()(Xe, "mysell", "我的出售"), ht()(Xe,
						"mybuy", "我的求購"), ht()(Xe, "realAuth", "實名認證"), ht()(Xe, "advAuth", "高級認證"), ht()(Xe, "linebuy", "在線購買"), ht()
					(Xe, "linesell", "在線出售"), ht()(Xe, "tipPay", "請在24小時內聯系商家付款，超出24小時將自動取消"), ht()(Xe, "notlow", "不能低於最低限額"), ht()
					(Xe, "nothigh", "不能超出最大限額"), ht()(Xe, "notnum", "不能超出最大數量"), ht()(Xe, "type", "類型"), ht()(Xe, "status", "狀態"),
					ht()(Xe, "seeOrder", "查看訂單"), ht()(Xe, "withdraw", "撤回"), ht()(Xe, "abnormal", "異常"), ht()(Xe, "psType",
						"請選擇類型"), ht()(Xe, "pselect", "請選擇"), ht()(Xe, "alipay", "支付寶"), ht()(Xe, "wechat", "微信"), ht()(Xe, "bank",
						"銀行卡"), ht()(Xe, "minNum", "最小交易量"), ht()(Xe, "maxNum", "最大交易量"), ht()(Xe, "wantBuy", "求購"), ht()(Xe, "pnums",
						"請輸入數量"), ht()(Xe, "pmin", "請輸入最小交易量"), ht()(Xe, "pmax", "請輸入最大交易量"), ht()(Xe, "pnot", "最大交易量不能小於最小交易量"), ht()
					(Xe, "myshops", "我的店鋪"), ht()(Xe, "name", "名稱"), ht()(Xe, "fiatSub", "所屬法幣"), ht()(Xe, "shoper_balance",
						"商家余額"), ht()(Xe, "enterShop", "進入店鋪"), ht()(Xe, "payedWait", "已付款，等待核實後確認"), ht()(Xe, "completeOrder",
						"商家已完成單"), ht()(Xe, "tradeCurrency", "交易幣種"), ht()(Xe, "closeBtn", "關閉"), ht()(Xe, "QRcode", "支付二維碼"), ht()(
						Xe, "imgUp", "圖片上傳失敗"), ht()(Xe, "please", "請於"), ht()(Xe, "Introvert", "内向"), ht()(Xe, "payment", "付款"), ht()
					(Xe, "hour", "時"), ht()(Xe, "minute", "分"), ht()(Xe, "second", "秒"), Xe),
				ctc: {
					ctc: "C2C",
					myRelease: "我發布的C2C",
					myTrade: "我交易的C2C",
				...
				set: ($e = {
					...
					code: "驗證碼",
					getCode: "獲取驗證碼"
				}, ht()($e, "setPsw", "設置密碼"), ht()($e, "enterPsw", "請輸入密碼"), ht()($e, "pswFalse", "兩次輸入的密碼不壹致"), ht()($e,
					"enterPswagain", "請再次輸入密碼"), ht()($e, "enterAccount", "請輸入賬號"), ht()($e, "enterCode", "請輸入驗證碼"), ht()($e,
					"accountFalse", "您輸入的手機或郵箱賬號不符合規則!"), ht()($e, "second", "秒"), ht()($e, "sendCode", "發送驗證碼"), ht()($e,
					"enterPswTwo", "請輸入兩次密碼"), ht()($e, "rest", "剩余"), ht()($e, "verification", "手機驗證"), $e),
				auth: {
					identity: "身份認證",
					name: "姓名",
					idcard: "身份證件",
			...
			fa = {
				...
				fat: (ta = {
						...
						shoperZname: "売買主支店",
						shoperNum: "売買主アカウント"
					}, ht()(ta, "odCeil", "注文キャンセル"), ht()(ta, "imPay", "お支払い済み、クリックしてご確認してください"), ht()(ta, "register_time",
						"登録時間"), ht()(ta, "odtotal", "総計リスト"), ht()(ta, "odmonth", "30日間完成リスト"), ht()(ta, "odfinish", "完成リスト"), ht()(
						ta, "odrate", "完成率"), ht()(ta, "submit", "発表"), ht()(ta, "phone", "携帯電話"), ht()(ta, "email", "メールボックス"), ht()
					(ta, "mysell", "売却"), ht()(ta, "mybuy", "仕入れ"), ht()(ta, "realAuth", "実名認証"), ht()(ta, "advAuth", "高級認証"), ht()
					(ta, "linebuy", "オンライン購入"), ht()(ta, "linesell", "オンライン売出す"), ht()(ta, "tipPay",
						"24時間を超えると自動的にキャンセルするため、24時間以内に業者と連絡を取ってください"), ht()(ta, "notlow", "最低限度額を下回ることはできません"), ht()(ta, "nothigh",
						"最大限度額を超えてはいけません"), ht()(ta, "notnum", "最大数量を超えてはいけません"), ht()(ta, "type", "タイプ"), ht()(ta, "status", "状態"),
					ht()(ta, "seeOrder", "注文書をチェック"), ht()(ta, "withdraw", "撤回"), ht()(ta, "abnormal", "異常"), ht()(ta, "psType",
						"お手数ですが、タイプを選択してください"), ht()(ta, "pselect", "お手数ですが、選択してください"), ht()(ta, "alipay", "支付宝"), ht()(ta, "wechat",
						"WeChat"), ht()(ta, "bank", "銀行カード"), ht()(ta, "minNum", "最小取付け量"), ht()(ta, "maxNum", "最大取引量"), ht()(ta,
						"wantBuy", "仕入れ"), ht()(ta, "pnums", "数量を入力してください"), ht()(ta, "pmin", "最小取引量を入力してください"), ht()(ta, "pmax",
						"最大取引量を入力してください"), ht()(ta, "pnot", "最大取引量が最小取引量より小さいことはできません"), ht()(ta, "myshops", "店舗"), ht()(ta, "name",
						"名称"), ht()(ta, "fiatSub", "法定貨幣属する"), ht()(ta, "shoper_balance", "売買主し残高"), ht()(ta, "enterShop", "入店"), ht()
					(ta, "payedWait", "お支払い済み、ご確認お願い致します"), ta),
				ctc: {
					ctc: "C2C",
					myRelease: "発表したC2C",
					myTrade: "取引したC2C",
				...
				set: (ea = {
					...
					code: "検証コード",
					getCode: "送信する"
				}, ht()(ea, "setPsw", "パスワードを設定"), ht()(ea, "enterPsw", "お手数ですが、パスワードをご入力してください"), ht()(ea, "pswFalse",
					"お手数ですが、二度ご入力したパスワードは一致しません"), ht()(ea, "enterPswagain", "お手数ですが、パスワードを再度ご入力してください"), ht()(ea, "enterAccount",
					"お手数ですが、アカウントをご入力してください"), ht()(ea, "enterCode", "お手数ですが、検証コードをご入力してください"), ht()(ea, "accountFalse",
					"すみませんですが、ご入力した携帯番号やメールアドレスは不規則でございます!"), ht()(ea, "second", "秒"), ht()(ea, "sendCode", "送信する"), ht()(ea,
					"enterPswTwo", "お手数ですが、パスワードを2回ご入力してください"), ht()(ea, "rest", "残り"), ea),
				auth: {
					identity: "身分認証",
					name: "名前",
					idcard: "身分証明書",
		...
		M.default.use(ha.a);
		var ya = "";
		"hk" == window.localStorage.getItem("lang") ? ya = window.localStorage.getItem("lang") : "en" == window.localStorage
			.getItem("lang") ? ya = window.localStorage.getItem("lang") : "jp" == window.localStorage.getItem("lang") ? ya =
			window.localStorage.getItem("lang") : (ya = "zh", window.localStorage.setItem("lang", "zh"));
		var _a = new ha.a({
				locale: ya,
				messages: {
					zh: pa,
		...
		M.default.use(Aa.a);
		var Ia, Sa = new Aa.a.Store({
			state: wa,
			mutations: ka
		});
		a("j1ja");
		M.default.component(Q.a.name, Q.a), M.default.component(N.a.name, N.a), M.default.component(L.a.name, L.a), M.default
			.component(E.a.name, E.a), M.default.component(B.a.name, B.a), M.default.component(I.a.name, I.a), M.default.component(
				w.a.name, w.a), M.default.component(C.a.name, C.a), M.default.component(_.a.name, _.a), M.default.component(f.a.name,
				f.a), M.default.component(g.a.name, g.a), M.default.component(h.a.name, h.a), M.default.component(d.a.name, d.a),
			M.default.component(l.a.name, l.a), M.default.component(o.a.name, o.a), ma.a.use(ua.a), M.default.use(Ca.a),
			window.eventBus = new M.default, Ia = location.host, location.origin, M.default.use(ca.a, Ia), M.default.config.productionTip = !
			1, Oe.a.interceptors.request.use(function(t) {
				return -1 === t.url.indexOf("?") ? t.url = t.url + "?_timespan=" + (new Date).getTime() : t.url = t.url +
					"&_timespan=" + (new Date).getTime(), t
			}, function(t) {
				return n.a.reject(t)
			}), Oe.a.interceptors.response.use(function(t) {
				if ("999" == t.data.type) {
					var e = localStorage.getItem("lang");
					"en" == e ? layer.msg("Logon is out of date, please login again") : layer.msg("登录过时，请重新登录"), localStorage.clear(),
						localStorage.setItem("lang", e), "#/" == window.location.hash || "#/components/login" == window.location.hash ?
						window.location.reload() : setTimeout(function() {
							ze.push("/components/login")
						}, 500)
				}
				return t
			}), M.default.config.productionTip = !1, Oe.a.defaults.transformRequest = [function(t) {
				return ra.a.stringify(t)
			}], M.default.use(ia.a, Oe.a), M.default.use(aa), M.default.filter("numFilter", function(t) {
				var e = Number(t).toFixed(5);
				return Number(e)
			}), M.default.filter("numFilters", function(t, e) {
				var a = Number(t),
					s = Number(e),
					i = Number(e - 0 + 1),
					n = "10".padEnd(i, 0) - 0;
		...
		var Ba = new M.default;
		M.default.prototype.bus = Ba, new M.default({
			el: "#app",
			i18n: _a,
			router: ze,
			store: Sa,
	...
	"PL/J": function(t, e) {
		...
		(a = jQuery).fn.qrcode = function(t) {
			...
			function n(t, e) {
				...
				for (var s = 0; s < t.length - a; s++) this.num[s] = t[s + a]
			}
			...
			s.prototype = {
				...
				addData: function(t) {
					this.dataList.push(new s(t)), this.dataCache = null
				},
				isDark: function(t, e) {
				...
				make: function() {
					if (1 > this.typeNumber) {
						var t = 1;
						for (t = 1; 40 > t; t++) {
							for (var e = r.getRSBlocks(t, this.errorCorrectLevel), a = new o, s = 0, i = 0; i < e.length; i++) s += e[
								i].dataCount;
							for (i = 0; i < this.dataList.length; i++) e = this.dataList[i], a.put(e.mode, 4), a.put(e.getLength(), c.getLengthInBits(
								e.mode, t)), e.write(a);
							if (a.getLengthInBits() <= 8 * s) break
						}
						this.typeNumber = t
					}
				...
				makeImpl: function(t, e) {
					...
					for (var a = 0; a < this.moduleCount; a++) {
						...
						for (var s = 0; s < this.moduleCount; s++) this.modules[a][s] = null
					}
				...
				setupPositionProbePattern: function(t, e) {
					for (var a = -1; 7 >= a; a++)
						if (!(-1 >= t + a || this.moduleCount <= t + a))
							for (var s = -1; 7 >= s; s++) - 1 >= e + s || this.moduleCount <= e + s || (this.modules[t + a][e + s] = 0 <=
								a && 6 >= a && (0 == s || 6 == s) || 0 <= s && 6 >= s && (0 == a || 6 == a) || 2 <= a && 4 >= a && 2 <=
								s && 4 >= s)
				},
				...
				createMovieClip: function(t, e, a) {
					for (t = t.createEmptyMovieClip(e, a), this.make(), e = 0; e < this.modules.length; e++) {
						...
						for (var s = 0; s < this.modules[e].length; s++) {
							var i = 1 * s;
							this.modules[e][s] && (t.beginFill(0, 100), t.moveTo(i, a), t.lineTo(i + 1, a), t.lineTo(i + 1, a + 1), t.lineTo(
								i, a + 1), t.endFill())
						}
					}
					return t
					...
					for (var t = c.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
						for (var a = 0; a < t.length; a++) {
							...
							if (null == this.modules[s][i])
								for (var n = -2; 2 >= n; n++)
									for (var r = -2; 2 >= r; r++) this.modules[s + n][i + r] = -2 == n || 2 == n || -2 == r || 2 == r || 0 ==
										n && 0 == r
						}
				},
				setupTypeNumber: function(t) {
					...
					for (a = 0; 18 > a; a++) s = !t && 1 == (e >> a & 1), this.modules[a % 3 + this.moduleCount - 8 - 3][Math.floor(
						a / 3)] = s
				},
				setupTypeInfo: function(t, e) {
					for (var a = c.getBCHTypeInfo(this.errorCorrectLevel << 3 | e), s = 0; 15 > s; s++) {
						var i = !t && 1 == (a >> s & 1);
						6 > s ? this.modules[s][8] = i : 8 > s ? this.modules[s + 1][8] = i : this.modules[this.moduleCount - 15 +
							s][8] = i
					}
					for (s = 0; 15 > s; s++) i = !t && 1 == (a >> s & 1), 8 > s ? this.modules[8][this.moduleCount - s - 1] = i :
						9 > s ? this.modules[8][15 - s - 1 + 1] = i : this.modules[8][15 - s - 1] = i;
						...
						for (6 == r && r--;;) {
							for (var o = 0; 2 > o; o++)
								if (null == this.modules[s][r - o]) {
									var l = !1;
									n < t.length && (l = 1 == (t[n] >>> i & 1)), c.getMask(e, s, r - o) && (l = !l), this.modules[s][r - o] =
										l, -1 == --i && (n++, i = 7)
				...
				if (s.getLengthInBits() > 8 * t) throw Error("code length overflow. (" + s.getLengthInBits() + ">" + 8 * t +
					")");
				for (s.getLengthInBits() + 4 <= 8 * t && s.put(0, 4); 0 != s.getLengthInBits() % 8;) s.putBit(!1);
				for (; !(s.getLengthInBits() >= 8 * t || (s.put(i.PAD0, 8), s.getLengthInBits() >= 8 * t));) s.put(i.PAD1, 8);
				return i.createBytes(s, e)
			}, i.createBytes = function(t, e) {
				for (var a = 0, s = 0, i = 0, r = Array(e.length), o = Array(e.length), l = 0; l < e.length; l++) {
					var u = e[l].dataCount,
						d = e[l].totalCount - u;
					s = Math.max(s, u), i = Math.max(i, d), r[l] = Array(u);
					for (var m = 0; m < r[l].length; m++) r[l][m] = 255 & t.buffer[m + a];
					for (a += u, m = c.getErrorCorrectPolynomial(d), u = new n(r[l], m.getLength() - 1).mod(m), o[l] = Array(m.getLength() -
							1), m = 0; m < o[l].length; m++) d = m + u.getLength() - o[l].length, o[l][m] = 0 <= d ? u.get(d) : 0
				}
				for (m = l = 0; m < e.length; m++) l += e[m].totalCount;
				for (a = Array(l), m = u = 0; m < s; m++)
					for (l = 0; l < e.length; l++) m < r[l].length && (a[u++] = r[l][m]);
				for (m = 0; m < i; m++)
					for (l = 0; l < e.length; l++) m < o[l].length && (a[u++] = o[l][m]);
				return a
			}, e = 4;
			for (var c = {
					...
					getBCHTypeInfo: function(t) {
						for (var e = t << 10; 0 <= c.getBCHDigit(e) - c.getBCHDigit(c.G15);) e ^= c.G15 << c.getBCHDigit(e) - c.getBCHDigit(
							c.G15);
						return (t << 10 | e) ^ c.G15_MASK
					},
					getBCHTypeNumber: function(t) {
						for (var e = t << 12; 0 <= c.getBCHDigit(e) - c.getBCHDigit(c.G18);) e ^= c.G18 << c.getBCHDigit(e) - c.getBCHDigit(
							c.G18);
						return t << 12 | e
					},
					...
					getErrorCorrectPolynomial: function(t) {
						for (var e = new n([1], 0), a = 0; a < t; a++) e = e.multiply(new n([1, l.gexp(a)], 0));
						return e
					},
					getLengthInBits: function(t, a) {
						if (1 <= a && 10 > a) switch (t) {
							case 1:
								return 10;
							case 2:
								return 9;
						...
						for (var e = t.getModuleCount(), a = 0, s = 0; s < e; s++)
							for (var i = 0; i < e; i++) {
								for (var n = 0, r = t.isDark(s, i), o = -1; 1 >= o; o++)
									if (!(0 > s + o || e <= s + o))
										for (var c = -1; 1 >= c; c++) 0 > i + c || e <= i + c || 0 == o && 0 == c || r == t.isDark(s + o, i + c) &&
											n++;
								5 < n && (a += 3 + n - 5)
							}
						for (s = 0; s < e - 1; s++)
							for (i = 0; i < e - 1; i++) n = 0, t.isDark(s, i) && n++, t.isDark(s + 1, i) && n++, t.isDark(s, i + 1) &&
								n++, t.isDark(s + 1, i + 1) && n++, (0 == n || 4 == n) && (a += 3);
						for (s = 0; s < e; s++)
							for (i = 0; i < e - 6; i++) t.isDark(s, i) && !t.isDark(s, i + 1) && t.isDark(s, i + 2) && t.isDark(s, i +
								3) && t.isDark(s, i + 4) && !t.isDark(s, i + 5) && t.isDark(s, i + 6) && (a += 40);
						for (i = 0; i < e; i++)
							for (s = 0; s < e - 6; s++) t.isDark(s, i) && !t.isDark(s + 1, i) && t.isDark(s + 2, i) && t.isDark(s + 3,
								i) && t.isDark(s + 4, i) && !t.isDark(s + 5, i) && t.isDark(s + 6, i) && (a += 40);
						for (i = n = 0; i < e; i++)
							for (s = 0; s < e; s++) t.isDark(s, i) && n++;
			...
			for (u = 8; 256 > u; u++) l.EXP_TABLE[u] = l.EXP_TABLE[u - 4] ^ l.EXP_TABLE[u - 5] ^ l.EXP_TABLE[u - 6] ^ l.EXP_TABLE[
				u - 8];
			for (u = 0; 255 > u; u++) l.LOG_TABLE[l.EXP_TABLE[u]] = u;
			return n.prototype = {
				get: function(t) {
					return this.num[t]
				},
				...
				multiply: function(t) {
					for (var e = Array(this.getLength() + t.getLength() - 1), a = 0; a < this.getLength(); a++)
						for (var s = 0; s < t.getLength(); s++) e[a + s] ^= l.gexp(l.glog(this.get(a)) + l.glog(t.get(s)));
					return new n(e, 0)
				},
				mod: function(t) {
					...
					for (var e = l.glog(this.get(0)) - l.glog(t.get(0)), a = Array(this.getLength()), s = 0; s < this.getLength(); s++)
						a[s] = this.get(s);
					for (s = 0; s < t.getLength(); s++) a[s] ^= l.gexp(l.glog(t.get(s)) + e);
				...
				for (var s = a.length / 3, i = [], n = 0; n < s; n++)
					for (var o = a[3 * n + 0], c = a[3 * n + 1], l = a[3 * n + 2], u = 0; u < o; u++) i.push(new r(c, l));
				return i
				...
				var e;
				if ("canvas" == t.render) {
					(e = new i(t.typeNumber, t.correctLevel)).addData(t.text), e.make();
					var s = document.createElement("canvas");
					s.width = t.width, s.height = t.height;
					for (var n = s.getContext("2d"), r = t.width / e.getModuleCount(), o = t.height / e.getModuleCount(), c = 0; c <
						e.getModuleCount(); c++)
	...
	VXUi: function(t, e, a) {
		...
		(function(t, e) {
			var s, i = a("Zx67"),
				...
				f = a.n(v);
			! function(s) {
				if ("object" == ("undefined" == typeof exports ? "undefined" : f()(exports)) && void 0 !== t) t.exports = s();
				else if ("function" == typeof define && a("nErl")) define([], s);
				else {
					("undefined" != typeof window ? window : void 0 !== e ? e : "undefined" != typeof self ? self : this).Clipboard
						= s()
				}
			}(function() {
				return function t(e, a, i) {
					function n(o, c) {
						if (!a[o]) {
							if (!e[o]) {
								if (!c && ("function" == typeof s && s)) return s(o, !0);
								if (r) return r(o, !0);
					...
					for (var r = "function" == typeof s && s, o = 0; o < i.length; o++) n(i[o]);
					return n
				}({
					1: [function(t, e, a) {
						var s = 9;
						if ("undefined" != typeof Element && !Element.prototype.matches) {
							...
							i.matches = i.matchesSelector || i.mozMatchesSelector || i.msMatchesSelector || i.oMatchesSelector || i
					...
					2: [function(t, e, a) {
						function s(t, e, a, s) {
							return function(a) {
								a.delegateTarget = i(a.target, e), a.delegateTarget && s.call(t, a)
							}
						}
						var i = t("./closest");
					...
					4: [function(t, e, a) {
						...
						e.exports = function(t, e, a) {
							...
							if (!s.fn(a)) throw new TypeError("Third argument must be a Function");
							if (s.node(t)) return function(t, e, a) {
							...
							if (s.nodeList(t)) return function(t, e, a) {
							...
							if (s.string(t)) return function(t, e, a) {
					...
					5: [function(t, e, a) {
						e.exports = function(t) {
							...
							if ("SELECT" === t.nodeName) t.focus(), e = t.value;
								...
								a || t.setAttribute("readonly", ""), t.select(), t.setSelectionRange(0, t.value.length), a || t.removeAttribute(
									"readonly"), e = t.value
							} else {
								t.hasAttribute("contenteditable") && t.focus();
								var s = window.getSelection(),
									i = document.createRange();
								i.selectNodeContents(t), s.removeAllRanges(), s.addRange(i), e = s.toString()
							}
							return e
						}
					}, {}],
					6: [function(t, e, a) {
						...
						s.prototype = {
							...
							once: function(t, e, a) {
								function s() {
									i.off(t, s), e.apply(a, arguments)
								}
								var i = this;
								return s._ = e, this.on(t, s, a)
							},
							emit: function(t) {
								for (var e = [].slice.call(arguments, 1), a = ((this.e || (this.e = {}))[t] || []).slice(), s = 0, i =
										a.length; s < i; s++) a[s].fn.apply(a[s].ctx, e);
								return this
							},
							off: function(t, e) {
								var a = this.e || (this.e = {}),
									...
									i = [];
								if (s && e)
									for (var n = 0, r = s.length; n < r; n++) s[n].fn !== e && s[n].fn._ !== e && i.push(s[n]);
					...
					7: [function(t, e, a) {
						! function(s, i) {
							if (void 0 !== a) i(e, t("select"));
							else {
								var n = {
									exports: {}
								};
								i(n, s.select), s.clipboardAction = n.exports
							}
						}(this, function(t, e) {
							var a = function(t) {
								...
								s = "function" == typeof g.a && "symbol" == f()(h.a) ? function(t) {
									...
									return t && "function" == typeof g.a && t.constructor === g.a && t !== g.a.prototype ? "symbol" :
								...
								i = function() {
									function t(t, e) {
										for (var a = 0; a < e.length; a++) {
											var s = e[a];
											s.enumerable = s.enumerable || !1, s.configurable = !0, "value" in s && (s.writable = !0), d()(t,
												s.key, s)
										}
									}
								...
								n = function() {
									...
									return i(t, [{
										...
										value: function() {
											...
											this.action = t.action, this.container = t.container, this.emitter = t.emitter, this.target =
												t.target, this.text = t.text, this.trigger = t.trigger, this.selectedText = ""
										}
									}, {
										key: "initSelection",
										value: function() {
										...
										value: function() {
											...
											this.removeFake(), this.fakeHandlerCallback = function() {
												...
												0, this.fakeElem = document.createElement("textarea"), this.fakeElem.style.fontSize = "12pt",
												this.fakeElem.style.border = "0", this.fakeElem.style.padding = "0", this.fakeElem.style.margin =
												"0", this.fakeElem.style.position = "absolute", this.fakeElem.style[e ? "right" : "left"] =
												"-9999px";
											var s = window.pageYOffset || document.documentElement.scrollTop;
											this.fakeElem.style.top = s + "px", this.fakeElem.setAttribute("readonly", ""), this.fakeElem.value =
												this.text, this.container.appendChild(this.fakeElem), this.selectedText = (0, a.default)(this
										...
										value: function() {
											this.fakeHandler && (this.container.removeEventListener("click", this.fakeHandlerCallback),
												this.fakeHandler = null, this.fakeHandlerCallback = null), this.fakeElem && (this.container.removeChild(
										...
										set: function(t) {
											if (void 0 !== t) {
												if (!t || "object" !== (void 0 === t ? "undefined" : s(t)) || 1 !== t.nodeType) throw new Error(
					...
					8: [function(t, e, a) {
						! function(s, i) {
							if (void 0 !== a) i(e, t("./clipboard-action"), t("tiny-emitter"), t("good-listener"));
							else {
								var n = {
									exports: {}
								};
								i(n, s.clipboardAction, s.tinyEmitter, s.goodListener), s.clipboard = n.exports
							}
							...
							var c = i(e),
								...
								y = function(t) {
									function e(t, a) {
										...
										return s.resolveOptions(a), s.listenClick(t), s
									}
									return function(t, e) {
										if ("function" != typeof e && null !== e) throw new TypeError(
											"Super expression must either be null or a function, not " + (void 0 === e ? "undefined" : f()(
												e)));
										...
										value: function() {
											var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
											this.action = "function" == typeof t.action ? t.action : this.defaultAction, this.target =
												"function" == typeof t.target ? t.target : this.defaultTarget, this.text = "function" ==
												typeof t.text ? t.text : this.defaultText, this.container = "object" === p(t.container) ? t.container :
												document.body
										}
									}, {
										key: "listenClick",
		...
		var s = {
			...
			i = {
				render: function() {
					...
					}, [a("div", [t._v("© 2018-2020 BINGLEY All Rights Reserved")]), t._v(" "), a("div", {
	...
	mJLu: function(t, e) {
		t.exports =
			"data:image/png;base64,"
	},
	mgS3: function(t, e) {},
	oq7i: function(t, e) {},
	ozXi: function(t, e) {},
