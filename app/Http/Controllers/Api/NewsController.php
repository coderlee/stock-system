...
class NewsController extends Controller
{
    ...
    public function getArticle(Request $request){
         ...
         if (empty($category_id)){
             $article = News::orderBy('id', 'desc')->paginate($limit);
         }else{
             $article = News::where('c_id',$category_id)->orderBy('id', 'desc')->paginate($limit,['*'], 'page', $page);
         }
         ...
         return $this->success(array("list"=>$article->items(), 'count' => $article->total(),
