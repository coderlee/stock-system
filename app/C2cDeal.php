...
//                $legal_deal_send->surplus_number += $legal_deal->number;//
                ...
                $data_wallet1 = [
                    ...
                    'after' => bc_add($users_wallet->lever_balance, $legal_deal->number, 5),
                ];
                $data_wallet2 = [
                    'balance_type' => 2,
                    'wallet_id' => $users_wallet->id,
                    ...
                    'change' => -$legal_deal->number,
                    'after' => bc_sub($users_wallet->lock_lever_balance, $legal_deal->number, 5),
                ];
//                $users_wallet->legal_balance += $legal_deal->number;
                $users_wallet->lever_balance = bc_add($users_wallet->lever_balance,$legal_deal->number,5);
//                $users_wallet->lock_legal_balance -= $legal_deal->number;
                $users_wallet->lock_lever_balance = bc_sub($users_wallet->lock_lever_balance,$legal_deal->number,5);
                $users_wallet->save();
